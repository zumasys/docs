...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="CCIJRemoteDynamicArrayRecord (jremote   API)";
        }
    }
    catch(err) {
    }
...
<dd><a href="../../../../../serialized-form.html#com.jbase.jremote.jca.cci.CCIJRemoteDynamicArrayRecord">Serialized Form</a></dd></dl>
