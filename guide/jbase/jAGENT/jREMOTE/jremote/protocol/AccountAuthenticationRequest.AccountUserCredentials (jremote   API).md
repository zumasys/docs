...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="AccountAuthenticationRequest.AccountUserCredentials (jremote   API)";
        }
    }
    catch(err) {
    }
...
<dd><a href="/39270-protocol/com_jbase_jremote_protocol_accountauthenticationrequest" title="class in com.jbase.jremote.protocol">AccountAuthenticationRequest</a></dd></dl>
* * *
