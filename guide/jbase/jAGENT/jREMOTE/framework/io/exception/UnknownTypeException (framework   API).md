# UnknownTypeException (framework   API)
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="UnknownTypeException (framework   API)";
        }
    }
    catch(err) {
    }
...
<dd><a href="../../../../../serialized-form.html#com.jbase.framework.io.exception.UnknownTypeException">Serialized Form</a></dd></dl>
