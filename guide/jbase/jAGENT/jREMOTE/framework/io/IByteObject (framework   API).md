...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="IByteObject (framework   API)";
        }
    }
    catch(err) {
    }
...
<dd><a href="/39220-io/com_jbase_framework_io_ByteObject" title="class in com.jbase.framework.io">ByteObject</a></dd></dl>
* * *
