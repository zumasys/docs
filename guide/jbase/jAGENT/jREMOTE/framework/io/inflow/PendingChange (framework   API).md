...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="PendingChange (framework   API)";
        }
    }
    catch(err) {
    }
...
<dd><a href="../../../../../constant-values.html#com.jbase.framework.io.inflow.PendingChange.REGISTER">Constant Field Values</a></dd></dl>
...
```
<dl><dt><span class="seeLabel">See Also:</span></dt>
<dd><a href="../../../../../constant-values.html#com.jbase.framework.io.inflow.PendingChange.CHANGEOPS">Constant Field Values</a></dd></dl>
