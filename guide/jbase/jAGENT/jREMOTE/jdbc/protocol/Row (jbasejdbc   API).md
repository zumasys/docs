...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Row (jbasejdbc   API)";
        }
    }
    catch(err) {
    }
...
- Class
- [Use](/39241-class-use/com_jbase_jdbc_protocol_class-use_row)
...
- [Prev Class](/39240-protocol/com_jbase_jdbc_protocol_RemoteInputRequest "class in com.jbase.jdbc.protocol")
- [Next Class](/39240-protocol/com_jbase_jdbc_protocol_SetPropertiesRequest "class in com.jbase.jdbc.protocol")


- [Frames](../../../../index.html?com/jbase/jdbc/protocol//39240-protocol/com_jbase_jdbc_protocol_Row)
- [No Frames](/39240-protocol/com_jbase_jdbc_protocol_Row)
