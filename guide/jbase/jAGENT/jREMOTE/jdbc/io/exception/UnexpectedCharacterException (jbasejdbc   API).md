...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="UnexpectedCharacterException (jbasejdbc   API)";
        }
    }
    catch(err) {
    }
...
<dd><a href="../../../../../serialized-form.html#com.jbase.jdbc.io.exception.UnexpectedCharacterException">Serialized Form</a></dd></dl>
