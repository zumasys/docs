...
**Title** The document title will be displayed in [ DOC.Q ](../../../DOC-REPORT/DOC-Q/index.md) and in the lookups.
...
New documents are automatically set to "Draft" status. Other statuses can only be changed by a document controller (administrator security level in [ DOC.CONTROL ](../../DOC-CONTROL/index.md) ) in [ DOC.E ](../../DOC-E/index.md) .
...
**Req Sign Type** The signoff type as defined in [ DOC.CONTROL ](../../DOC-CONTROL/index.md) .
