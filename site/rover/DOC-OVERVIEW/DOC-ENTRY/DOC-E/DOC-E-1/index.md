...
**Category** Enter a category, if desired. The valid values are defined in [DOC.CONTROL](../../DOC-CONTROL/index.md) .
  
**Title** Enter a title for the document. This will be displayed in [DOC.Q](../../../DOC-REPORT/DOC-Q/index.md) and in the lookups.
...
New documents are automatically set to "Draft" status. Other statuses can only be changed by a document controller (administrator security level in [DOC.CONTROL](../../DOC-CONTROL/index.md)).
...
**Req Sign Type** Enter the signoff type. These must be defined in [DOC.CONTROL](../../DOC-CONTROL/index.md).
  
**Req Sign User** Enter the signoff userid. This is optional. If entered, this userid will be allowed to sign off a pending revision. If not entered, then any user within the signoff type will be allowed to sign off a pending revision. The association of which users belong to which types is defined in [DOC.CONTROL](../../DOC-CONTROL/index.md).
