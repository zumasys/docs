...
**Form Details**  
[General](DOC-E-1/index.md)
[Revision History](DOC-E-2/index.md)
[Change History](DOC-E-3/index.md)

**Purpose**  
The DOC.E procedure is used to enter new documents into the system and to change existing documents. This can only be done by "Admin" type users as defined in [DOC.CONTROL](../index.md) .
...
**Prerequisites**  
Initialization of the document control record ( [DOC.CONTROL](../index.md) ).
