...
**Use Ship Date** If this option is selected, [ SHIP.R1 ](../../../MRK-REPORT/SHIP-R1/index.md) will be launched for you after all shippers have been created. The shipper numbers will be loaded into the [ SHIP.R1 ](../../../MRK-REPORT/SHIP-R1/index.md) procedure for you so you do not have to re-enter them.   
