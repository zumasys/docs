##  Commission Purge Process (COMM.P1)

<PageHeader />

**Form Details**  
[ Form Details ](COMM-P1-1/README.md)   

**Purpose**  
The COMM.P1 procedure is used to purge commission records from the data base.
The criteria used to deterime which records are purged is based on a user
defined cut-off date. All commission records whose creation date is less than
or equal to the cut-off date will be deleted.
