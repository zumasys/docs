...
**Form Details**  
[ General ](ROUTE-E-1/index.md)   
[ Route Stops ](ROUTE-E-2/index.md)   
...
The route record is also used when creating Routeship records via [ ROUTESHIP.E ](../ROUTESHIP-E/index.md) or [ ROUTESHIP.P1 ](../../MRK-PROCESS/ROUTESHIP-P1/index.md) for delivery of the shipments for the customers on the route. 
