...
**Last FAIL.P1 Date** Contains the last date through which the [ FAIL.P1 ](../../../MRK-PROCESS/FAIL-P1/index.md) process to collect MTBF data has been run. This data is posted by the [ FAIL.P1 ](../../../MRK-PROCESS/FAIL-P1/index.md) procedure and may not be updated.   
