...
**Form Details**  
[ Form Details ](CAMPAIGN-E-1/index.md)   
...
**Prerequisites**  
If group codes are to be used for determining which customers and prospects are to be included in a campaign they must forst be defined in the [ GROUP.CONTROL ](../GROUP-CONTROL/index.md) procedure and referenced on each customer or prospect. 
