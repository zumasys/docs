...
**Form Details**  
[ General ](ROUTESHIP-E-1/index.md)   
[ Route Stops ](ROUTESHIP-E-2/index.md)   
...
The Routeship ID is stored on each shipment record. A shipment may only be referenced on one routeship record. ROUTESHIP records can also be created through a batch method using [ ROUTESHIP.P1 ](../../MRK-PROCESS/ROUTESHIP-P1/index.md) . 
