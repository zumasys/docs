...
**Qty** The quantity breaks to use for this quote. This field is originally defaulted from the [ QUOTE.CONTROL ](../../QUOTE-CONTROL/index.md) record and may be changed as needed.   
...
**Markup Pct** The markup percentages for each quantity break. This field is originally defaulted from the [ QUOTE.CONTROL ](../../QUOTE-CONTROL/index.md) record and may be changed as needed.   
