...
**Expire Date** The date on which this quote expires. This is originally defaulted by adding the valid days from the [ QUOTE.CONTROL ](../../QUOTE-CONTROL/index.md) screen to the quote date. It may then be changed as required.   
