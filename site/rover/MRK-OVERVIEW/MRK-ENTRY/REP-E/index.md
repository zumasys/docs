...
- [General](REP-E-1/index.md)
- [Contacts](REP-E-2/index.md)
- [Contact Log](REP-E-3/index.md)
- [Attachments](REP-E-4/index.md)
...
There are fields for start and inactive dates in this procedure so that you can track when the rep started and stopped working for your company. When a rep becomes inactive, it is recommended that you run the [CUST.R2](../../../AR-OVERVIEW/AR-REPORT/CUST-R2/index.md) report for the rep. This report will give you a listing of all customers that have been assigned to this rep. Until the rep is removed from the customer record, it will get loaded into new quotes and sales orders.
