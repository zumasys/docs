...
**Inactive Date** Enter the date this rep stooped working for your company. After inactivating a rep, you should run a report called [ CUST.R2 ](../../../../AR-OVERVIEW/AR-REPORT/CUST-R2/index.md) to list all customers that have been assigined to this rep. Untill the rep is removed from the customer record (i.e. [ CUST.E ](../../../../AR-OVERVIEW/AR-ENTRY/CUST-E/index.md) ), it will get loaded into new quotes and sales orders.   
...
**1099 Box** Enter the box on the 1099 form which is to used to print forms for this rep. This field will be used as a default into the [ CHECKS.E ](../../../../AP-OVERVIEW/AP-ENTRY/CHECKS-E/index.md) procedure.   
