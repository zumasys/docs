...
**Form Details**  
[ General ](COMM-E-1/index.md)   
[ Change History ](COMM-E-2/index.md)   

**Purpose**  
The COMM.E procedure provides for the entry and maintenance of the Commission file (COMM). The ID to each commission record is sequentially assigned by the system. Each record contains detail information from the shipment process which is automatically created during the [ SHIP.P1 ](../../MRK-PROCESS/SHIP-P1/index.md) procedure.   
