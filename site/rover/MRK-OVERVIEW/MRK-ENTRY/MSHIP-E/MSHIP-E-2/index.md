...
**UM** This is the unit of measure for the associated part number as defined in [ Parts.E ](../../../../ENG-OVERVIEW/ENG-ENTRY/PARTS-E/index.md) . It is for reference only and cannot be changed.   
