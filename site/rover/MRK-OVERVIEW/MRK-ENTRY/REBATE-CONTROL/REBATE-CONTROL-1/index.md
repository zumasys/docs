...
**Account Number** Enter the default account number that should be used when issuing a credit for this type of rebate. A account number may, also, be defined per customer in [ CUST.E ](../../../../AR-OVERVIEW/AR-ENTRY/CUST-E/index.md) .   
...
You will have an option in [ CUST.E ](../../../../AR-OVERVIEW/AR-ENTRY/CUST-E/index.md) to load in these defaults.   
