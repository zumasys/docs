...
**Form Details**  
[ Definition ](COUPON-E-1/index.md)   
[ Usage History ](COUPON-E-2/index.md)   

**Purpose**  
The purpose of COUPON.E is to enter or modify coupon data that is to be used in [ SO.E ](../SO-E/index.md) and the eCommerce site. Each coupon can be defined with parameters such as certain parts, customers, categories or web categories that limit which orders or line items within orders that the coupon will apply to. The coupon must be defined with a discount percent or a discount amount, but not both. Also, minimum order amounts or maximum discount amounts can be specified. Additionally, maximum number of uses overall or by customer can be defined for the coupon.   
