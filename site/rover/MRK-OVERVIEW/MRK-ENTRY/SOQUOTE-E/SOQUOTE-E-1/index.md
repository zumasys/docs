...
**Valid Thru** The date through which this quote is valid. This date is originally defaulted as the quote date plus the number of days identified in the [ QUOTE.CONTROL ](../../QUOTE-CONTROL/index.md) record.   
...
**Cost Method** This field will control how line item prices will be derived. It originally defaults from the [ QUOTE.CONTROL ](../../QUOTE-CONTROL/index.md) screen and can be changed per quote as required.   
