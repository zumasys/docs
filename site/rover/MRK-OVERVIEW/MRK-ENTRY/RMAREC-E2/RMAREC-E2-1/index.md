...
**Post To AR** Check this box if you wish to create an a/r record for this receipt. When the receipt is posted (via [ rmarec.p1 ](../../../MRK-PROCESS/RMAREC-P1/index.md) ) the "post to a/r" field in [ RMA.E ](../../RMA-E/index.md) will be updated.   
...
**PO** This field contains the customer purchase order number. It is originally defaulted from the [ RMA.E ](../../RMA-E/index.md) screen and can be changed, if required.   
