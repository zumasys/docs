...
**Include Handling in Freight** Check this box if you wish to include the handling charge in the freight amount that will be charged to the customer. If this box is not checked and a handling charge is imported in from the freight carrier, it will be referenced on the packages tab in [ ship.e2 ](../../SHIP-E2/index.md) but will not be included in the freight amount on the header tab of [ ship.e2 ](../../SHIP-E2/index.md) . The freight amount on the header tab of [ ship.e2 ](../../SHIP-E2/index.md) is the freight amount that is charged to the customer.   
  
**Include Insurance in Freight** Check this box if you wish to include the insurance (declared value) charge in the freight amount that will be charged to the customer. If this box is not checked and an insurance charge is imported in from the freight carrier, it will be referenced on the packages tab in [ ship.e2 ](../../SHIP-E2/index.md) but will not be included in the freight amount on the header tab of [ ship.e2 ](../../SHIP-E2/index.md) . The freight amount on the header tab of [ ship.e2 ](../../SHIP-E2/index.md) is the freight amount charged to the customer.   
