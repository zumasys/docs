...
**Export Restrictions** Check this box to enable export restrictions. This will enable certain edits in [ CUST.E ](../../../../AR-OVERVIEW/AR-ENTRY/CUST-E/index.md) , [ SO.E ](../../SO-E/index.md) and shipping regarding the customer export flag and the ship to country and end user country. The limit entries box must also be checked.   
