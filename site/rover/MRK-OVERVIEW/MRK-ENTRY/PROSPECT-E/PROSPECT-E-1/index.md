...
**Status** Enter the status of this prospect. The list of valid entries for this field may be defined in [ PROSPECT.CONTROL ](../../PROSPECT-CONTROL/index.md) . If that list is left empty, then any user defined status code may be used.   
...
**Status Desc** This field contains the description of the status code, as it appears in the [ PROSPECT.CONTROL ](../../PROSPECT-CONTROL/index.md) record.   
