...
- [Shipment Header](SHIP-E2-1/index.md)
- [Shipment Line Items](SHIP-E2-2/index.md)
- [Picking List](SHIP-E2-3/index.md)
- [Summary Line Items](SHIP-E2-4/index.md)
- [Packages](SHIP-E2-5/index.md)
- [Change History](SHIP-E2-6/index.md)

**Purpose**  
The SHIP.E2 procedure is used to confirm shipments. A shipment could emanate from three (3) possible places. First, the [SHIP.E](../SHIP-E/index.md) procedure can create the original shipment record. Second, the [SO.P1](../../MRK-PROCESS/SO-P1/index.md) process could have created the shipment, and the [SHIP.E](../SHIP-E/index.md) procedure could be bypassed. Lastly, SHIP.E2 can be used to both create and confirm shipments, directly from a sales order, without necessitating the use of [SHIP.E](../SHIP-E/index.md) . This may be used for entering "after-the-fact" shipments (those which have already been shipped without paperwork in case of emergency). It is, however, more common to first execute the [SHIP.E](../SHIP-E/index.md) procedure in conjunction with the shipping pick list.
...
**Prerequisites**  
Initialization of the marketing control record ( [MRK.CONTROL](../MRK-CONTROL/index.md) ), entry of the required inventory locations and creation of sales orders.
