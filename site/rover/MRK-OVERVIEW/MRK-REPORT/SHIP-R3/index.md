##  Confirmed Shipments Not Posted (SHIP.R3)

<PageHeader />

**Form Details**  
[ Form Details ](SHIP-R3-1/index.md)   

**Purpose**  
The SHIP.R3 procedure is used to print a listing of all shipment records which have not been posted by the [ SHIP.P1 ](../../MRK-PROCESS/SHIP-P1/index.md) procedure. The report is sorted by shipment date. 
