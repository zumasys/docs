...
**Form Details**  
[ Form Details ](RMAREC-R2-1/index.md)   

**Purpose**  
The RMAREC.R2 procedure is used to create multi-line RMA receipt travelers. The multi-line receipt traveler shows all of the items on one page. To print travelers with one line item per page user [ RMAREC.R1 ](../../../../rover/MRK-OVERVIEW/MRK-REPORT/RMAREC-R1/index.md) . 
...
**Receipt Date** The date the receipt was made as entered in the [ RMAREC.E ](../../MRK-ENTRY/RMAREC-E/index.md) or [ RMAREC.E2 ](../../MRK-ENTRY/RMAREC-E2/index.md) procedure.   
