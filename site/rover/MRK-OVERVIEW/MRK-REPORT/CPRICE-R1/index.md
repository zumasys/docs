##  Contract Price Listing by Date (CPRICE.R1)

<PageHeader />

**Form Details**  
[ Form Details ](CPRICE-R1-1/index.md)   

**Purpose**  
The CPRICE.R1 procedure provides the ability to list all of the contract prices defined in the [ CPRICE.E ](../../MRK-ENTRY/CPRICE-E/index.md) procedure. Optional entries are for active contracts only or contracts for certain customers only. The report is listed in contract number sequence. 
...
**Contract Number** The contract number as entered in [ CPRICE.E ](../../MRK-ENTRY/CPRICE-E/index.md) .   
