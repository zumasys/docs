...
**Summary** Check this box, if you wish to show the totals by invoice and not
by part number.  
  
**Print Grand Total** Select this option if you wish to print a grand total
for all reps. If this option is selected, a separate page will print with the
total.  
  
**Rep**  
  
**Rep Name** This field contans the rep's name.  
