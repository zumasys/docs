...
be included in the listing. If no date is entered, the current date is used as
the cutoff.  
  
**WO.SO.Flag** Check here if you want to list only the work orders tied to the
individual sales orders in the listing. If not checked, then the list will
