...
**Name** Contains the name of the rep associated with the rep number entered.
It may not be changed.  
  
**Customer** If you wish to limit this report to specific customers, enter the
customer numbers in this field. To include all customers leave the field
...
**RMA Sales** Chose an option if you want to include only sales from RMA's or
exclude them. Leave blank to ignore this option.  
