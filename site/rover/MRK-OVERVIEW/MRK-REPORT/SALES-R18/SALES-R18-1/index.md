...
**Price Code** If you wish to limit this report to certain pricing/customer codes, enter those code in this field. Please note that this report will use the default pricing code that has been defined for the customer in [ CUST.E ](../../../../AR-OVERVIEW/AR-ENTRY/CUST-E/index.md) and not the pricing code entered on the order.   
