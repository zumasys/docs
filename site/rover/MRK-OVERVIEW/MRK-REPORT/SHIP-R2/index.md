...
**Form Details**  
[ Form Details ](SHIP-R2-1/index.md)   

**Purpose**  
The SHIP.R2 procedure is used to print a listing of all shipment records which have not been confirmed with the [ SHIP.E2 ](../../MRK-ENTRY/SHIP-E2/index.md) procedure by setting the shipment status to "S" shipped. The report is sorted by shipment date. 
