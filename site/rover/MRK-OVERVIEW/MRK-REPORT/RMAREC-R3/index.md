##  RMA Receipts Listing by Date (RMAREC.R3)

<PageHeader />

**Form Details**  
[ Form Details ](RMAREC-R3-1/index.md)   

**Purpose**  
The [ RMA.R1 ](../../../../rover/MRK-OVERVIEW/MRK-REPORT/RMA-R1/index.md) procedure is used to list all RMA receipts for a date range. The report is sorted by the date of the receipt. 
