...
**Quantity** Enter a quantity if you want to have it used in the price configuration process. This would apply if quantity price breaks are defined in [ PRICE.E ](../../../MRK-ENTRY/PRICE-E/index.md) . If no quantity is entered, then a quantity of one is assumed.   
