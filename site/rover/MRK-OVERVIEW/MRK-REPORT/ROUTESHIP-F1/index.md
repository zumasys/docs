##  Shipment Delivery Route Printing (ROUTESHIP.F1)

<PageHeader />

**Form Details**  
[ Form Details ](ROUTESHIP-F1-1/index.md)   
...
**Route Description** The description of this particular route as entered in [ ROUTESHIP.E ](../../MRK-ENTRY/ROUTESHIP-E/index.md) .   
...
**Driver** The driver as entered in [ ROUTESHIP.E ](../../MRK-ENTRY/ROUTESHIP-E/index.md) , or can be manually written.   
**Trailer** The trailer as entered in [ ROUTESHIP.E ](../../MRK-ENTRY/ROUTESHIP-E/index.md) , or can be manually written.   
