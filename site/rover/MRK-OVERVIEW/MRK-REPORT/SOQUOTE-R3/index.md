##  Quote Listing by Customer (SOQUOTE.R3)

<PageHeader />

**Form Details**  
[ Form Details ](SOQUOTE-R3-1/index.md)   

**Purpose**  
SOQUOTE.R3 provides a report of all quotes entered through [ SOQUOTE.E ](../../MRK-ENTRY/SOQUOTE-E/index.md) in customer number sequence. You may limit the listing to a start and/or end date range, specific customers, and for a specific status. 
