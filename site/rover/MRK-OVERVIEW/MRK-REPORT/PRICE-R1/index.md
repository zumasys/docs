##  Price Listing (PRICE.R1)

<PageHeader />

**Form Details**  
[ Form Details ](PRICE-R1-1/index.md)   

**Purpose**  
The PRICE.R1 procedure provides the ability to list all of the prices defined in the [ PRICE.E ](../../MRK-ENTRY/PRICE-E/index.md) procedure. The report is listed in part number sequence. 
