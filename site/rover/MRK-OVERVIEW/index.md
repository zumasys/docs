...
- [Data Entry Procedures](MRK-ENTRY/index.md)
- [Reports and Inquiries](MRK-REPORT/index.md)
- [Update Processes](MRK-PROCESS/index.md)
...
[TERMS.E](../../rover/AP-OVERVIEW/AP-ENTRY/TERMS-E/index.md) Definition of the payment terms for customers
[CUST.E](../AR-OVERVIEW/AR-ENTRY/CUST-E/index.md) Identification of customers
[MRK.CONTROL](MRK-ENTRY/MRK-CONTROL/index.md) Definition of control information used in the module
  
Optionally, the following setup procedures can be performed to make complete
use of all available marketing functions:  
  
[REP.E](MRK-ENTRY/REP-E/index.md) Identification of sales representatives
[PRICE.E](MRK-ENTRY/PRICE-E/index.md) Entry of product prices
[FAIL.CONTROL](MRK-ENTRY/FAIL-CONTROL/index.md) Definition of valid failure codes for RMA processing
[MTBF.CONTROL](MRK-ENTRY/MTBF-CONTROL/index.md) Definition of MTBF calculation parameters
[STAX.E](../AR-OVERVIEW/AR-ENTRY/STAX-E/index.md) Sales tax

**Flow of Activities**  
The flow of processing for the marketing module begins with the entry of the sales order in the [SO.E](MRK-ENTRY/SO-E/index.md) procedure. All items which are sold should be entered in the sales order file, including items which do not have a specific part number assigned, such as non-inventory items. The procedure allows the deletion of the sales order record, provided there have been no shipments made against it.
  
After the sales order is on file, shipments may be made against that order, either using the batch shipment creation procedure ( [SO.P1](MRK-PROCESS/SO-P1/index.md) ), or creating a single shipment record in the [SHIP.E](MRK-ENTRY/SHIP-E/index.md) procedure. Once created, the shipper is considered "requested" and a shipment picklist can be printed. Generally, the picklist is manually filled in with the actual shipment information such as ship quantity, and that information is then entered into the [SHIP.E2](MRK-ENTRY/SHIP-E2/index.md) procedure which will move inventory.
  
Once the [SHIP.E2](MRK-ENTRY/SHIP-E2/index.md) procedure has been executed against a shipment, the [SHIP.P1](MRK-PROCESS/SHIP-P1/index.md) procedure will post the shipping information, updating the sales history file (SALES), the commission file (COMM) and, when active will update the accounts receivable module with the amounts due. If an error is discovered in the shipment after posting then a shipment reversal may be done with the [SHIP.E3](MRK-ENTRY/SHIP-E3/index.md) procedure.
  
Prior to posting, changes may be made to the shipper via [SHIP.E2](MRK-ENTRY/SHIP-E2/index.md) . Once it has been posted, the shipper can be reversed via [SHIP.E3](MRK-ENTRY/SHIP-E3/index.md) . When the record is saved the inventory transactions will be reversed and when the record is posted reversing sales, commission and accounts receivable records will be created.
  
Authorizations for returned merchandise may be entered with [RMA.E](MRK-ENTRY/RMA-E/index.md) . The rma record may be created from a shipment, sales order or field service order. Receipts may be made against an rma for the full or partial amount via [RMAREC.E](MRK-ENTRY/RMAREC-E/index.md) and [RMAREC.E2](MRK-ENTRY/RMAREC-E2/index.md) . The intent of of [RMAREC.E](MRK-ENTRY/RMAREC-E/index.md) is to allow personnel on the receiving dock to identify what has been received. However, inventory will not be moved against this receipt until it has been confirmed via [RMAREC.E2](MRK-ENTRY/RMAREC-E2/index.md) .
  
In addtion to confirming the receipt, [RMAREC.E2](MRK-ENTRY/RMAREC-E2/index.md) allows entry of additional information such as failure codes, miscellaneous charges, etc. Once the receipt has been confirmed, it can be posted via [RMAREC.P1](MRK-PROCESS/RMAREC-P1/index.md) . The posting process updates the sales history file (SALES), the commissions file (COMM) and the accounts receivable file (AR). An accounts receivable credit memo will only be created if the rma record has been flagged to create one.
  
Prior to posting, changes may be made to the rma receipt via [RMAREC.E2](MRK-ENTRY/RMAREC-E2/index.md) . Once the receipt has been posted, it can be reversed via [RMAREC.E3](MRK-ENTRY/RMAREC-E3/index.md) . When the record is saved the inventory transactions will be reversed and when the record is posted reversing sales, commission and accounts receivable (if applicable) records will be created.
  
The maintenance of the Customer file ( [CUST.E](../AR-OVERVIEW/AR-ENTRY/CUST-E/index.md) ) and the Terms file ( [TERMS.E](../../rover/AP-OVERVIEW/AP-ENTRY/TERMS-E/index.md) ) should be done as new items are required or changes need to be made.
