...
- **Rover Web**
  ...
  - **Point of Sale**
    - Adds ability to add non-stock items to orders. Requires update to [MRK.CONTROL](../../../MRK-OVERVIEW/MRK-ENTRY/MRK-CONTROL/MRK-CONTROL-6/index.md#allow-non-stock-parts).
