...
- **Rover Web**
  - **Inventory Module**
    ...
    - Added ability to add lookup table to the Parts view. Requires update to [INV.CONTROL](../../../INV-OVERVIEW/INV-ENTRY/INV-CONTROL/INV-CONTROL-2/index.md).
  - **Point of Sale**
    - Add ability to display "New Customer" button on the main POS screen. Requires update to [MRK.CONTROL](../../../MRK-OVERVIEW/MRK-ENTRY/MRK-CONTROL/MRK-CONTROL-6/index.md#pos-show-new-customer-button).
