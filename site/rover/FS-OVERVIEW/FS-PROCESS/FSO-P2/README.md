##  Service Order Purge Process (FSO.P2)

<PageHeader />

**Form Details**  
[ Form Details ](FSO-P2-1/README.md)   

**Purpose**  
The FSO.P2 procedure is used to purge inactive field service orders from the
data base. The criteria used to deterime which records are purged is based on
a user defined cut-off date. All posted service order records which have a
