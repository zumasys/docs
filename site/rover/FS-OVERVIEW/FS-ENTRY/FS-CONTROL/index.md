...
**Form Details**  
[ General ](FS-CONTROL-1/index.md)   
[ Service Units ](FS-CONTROL-2/index.md)   
[ Service Codes ](FS-CONTROL-3/index.md)   
[ Operations ](FS-CONTROL-4/index.md)   
[ Charge Rates ](FS-CONTROL-5/index.md)   
[ Charge Back Rates ](FS-CONTROL-6/index.md)   

**Purpose**  
The FS.CONTROL procedure is used to define various tables of information that
are used in the field service procedures.  
  
The first tab contains default information such as the sales account number and cost of goods sold location, which are loaded during the entry of a field service order ( [ FSO.E ](../FSO-E/index.md) ).   
...
**Prerequisites**  
The sales account number must have been defined in the GL chart of accounts ( [ GLCHART.E ](../../../GL-OVERVIEW/GL-ENTRY/GLCHART-E/index.md) ), and the cost of goods sold location must have been defined using [ INVLOC.E ](../../../INV-OVERVIEW/INV-ENTRY/INVLOC-E/index.md) . 
