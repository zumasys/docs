...
**Manual Adjust Account** Enter the general ledger account number to be used as the offset account for manual average cost adjustments entered in the [ COSTADJ.E ](../../COSTADJ-E/index.md) procedure.   
  
**Rollover Adjust Account** Enter the general ledger account number to be used as the offset account for cost adjustments made by the cost rollover procedure ( [ COST.P2 ](../../../../ENG-OVERVIEW/ENG-PROCESS/COST-P2/index.md) ) or the cost rollup procedure ( [ COST.P1 ](../../../../ENG-OVERVIEW/ENG-PROCESS/COST-P1/index.md) ).   
  
**Trans History Days** Enter the number of days of history to be kept on the Inventory file for viewing on [ INV.Q ](../../../INV-REPORT/INV-Q/index.md) . All history will still be maintained on the Inventory Transaction file and can still be viewed via the IT.R series reports. Please note that [ INV.P2 ](../../../INV-PROCESS/INV-P2/index.md) will need to be run after making a change in this field.   
  
**Conversion Location** Enter an adjustment location to be used in [ IT.E4 ](../../IT-E4/index.md) for inventory conversion. This will be a pass-through location for the parts being consumed and the parts being created to be moved into and out of.   
  
**Months of Usage** Enter the number of months of usage to maintain in the Usage file. During the [ USAGE.P1 ](../../../INV-PROCESS/USAGE-P1/index.md) process, all months in excess of this number will be dropped. If this field is left blank, 12 months are maintained.   
