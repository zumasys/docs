...
**Prerequisites**  
Entry of valid inventory locations ( [ INVLOC.E ](../INVLOC-E/index.md) ) and assignment of the conversion adjustment location in [ INV.CONTROL ](../INV-CONTROL/index.md) . 
