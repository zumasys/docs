...
**Adj Loc** This is the adjustment location that will be used for the inventory transactions. This is just a pass-through location. It will be defaulted from the [ INV.CONTROL ](../../INV-CONTROL/index.md) "Conversion Location" entry, but can be changed.   
