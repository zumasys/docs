...
**Form Details**  
[ Summary Balances ](INV-Q-1/index.md)   
[ Commitments ](INV-Q-2/index.md)   
[ Allocations ](INV-Q-3/index.md)   
[ Shortages ](INV-Q-4/index.md)   
[ On Order ](INV-Q-5/index.md)   
[ Usage History ](INV-Q-6/index.md)   
[ Lot Information ](INV-Q-7/index.md)   
[ Transactions ](INV-Q-8/index.md)   
[ Images ](INV-Q-9/index.md)   
...
There is, also, a tab to display the inventory transaction history for the part number for a selected number of days. In the [ INV.CONTROL ](../../INV-ENTRY/INV-CONTROL/index.md) procedure, there is a field that controls how may days of transaction history will be viewed in this procedure. Transactions created prior to that point can still be viewed by running the inventory transaction reports. The inventory transaction reports can be found in the report section of the inventory module and begin with the term IT.R. 
