...
**Created.By** A name which describes the procedure which caused the transaction to occur. These include [ IT.E ](../../INV-ENTRY/IT-E/index.md) , RECEIPTS, PICKER, PHYS, CYCLE and SHIPMENT.   
