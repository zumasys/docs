...
**Include Zero Inventory Tags** Check this box, if you wish to include the tags that were created to zero out inventory. These tags are created during the [ PHYS.P1 ](../../../INV-PROCESS/PHYS-P1/index.md) procedure.   
