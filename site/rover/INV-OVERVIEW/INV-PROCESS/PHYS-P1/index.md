...
**Form Details**  
[ Form Details ](PHYS-P1-1/index.md)   
...
**Prerequisites**  
The physical inventory control data must be entered into the [ INV.CONTROL ](../../INV-ENTRY/INV-CONTROL/index.md) procedure to define the parameters of a physical. It is incumbent upon the user to stop inventory movements when the actual count is in process. 
