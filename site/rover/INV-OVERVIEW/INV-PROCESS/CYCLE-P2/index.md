...
**Form Details**  
[ Form Details ](CYCLE-P2-1/index.md)   
...
**Prerequisites**  
The cycle count for the selected date must have been done and the counted entered through [ CYCLE.E ](../../INV-ENTRY/CYCLE-E/index.md) . It is also highly recommended that the Cost Variation report ( [ CYCLE.R3 ](../../INV-REPORT/CYCLE-R3/index.md) ) be run to get a preview of what effect the posting will have. 
