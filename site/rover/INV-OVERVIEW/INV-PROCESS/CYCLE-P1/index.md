...
**Form Details**  
[ Form Details ](CYCLE-P1-1/index.md)   
...
The cycle date is initially assigned to the inventory file when [ INV.P1 ](../INV-P1/index.md) is processed or when a new part is created in [ PARTS.E ](../../../ENG-OVERVIEW/ENG-ENTRY/PARTS-E/index.md) . The cycle date is updated in the inventory file each time the part is included in a cycle count. Please note that the cycle count must be posted via [ CYCLE.P2 ](../CYCLE-P2/index.md) for the count and cycle date to be updated.   
...
**Prerequisites**  
Stratification of the ABC codes into the Parts file ( [ PARTS.P1 ](../../../ENG-OVERVIEW/ENG-PROCESS/PARTS-P1/index.md) ) and assignment of the cycle dates into the Inv file ( [ INV.P1 ](../INV-P1/index.md) ). 
