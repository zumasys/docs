...
<PageHeader />
This endpoint authorizes a tokenized form of payment and captures the payment.  A Token can be obtained using the `BLTOKENIZE` endpoint.
...
| fee_exclude_amount | Optional fee amount to exclude from surcharge calculation. Used for exclude surcharge on tips.                                                               |                    |
