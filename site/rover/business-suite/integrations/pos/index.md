...
```
> Requires `SO.E` or `PSO.E`to be defined in the user commands. If [command rights](../security/index.md#command-rights) are enabled, `view` must be set to `true`.
...
> Requires `SOQUOTE.E` to be defined in the user commands. If [command rights](../security/index.md#command-rights) are enabled, `view` must be set to `true`.
