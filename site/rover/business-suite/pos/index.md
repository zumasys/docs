...
> NOTE: Please note that while you may use this version in tandem with [Smart Suite POS](index.md), closing the register in one application will result in the register being closed for the other application.
