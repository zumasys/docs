...
**Form Details**  
[ Form Details ](ARTAX-R2-1/index.md)   
...
the ARTAX file.  
**Date** The date on which the ARTAX record was created. This should normally be the same as the AR record date. It will only differ if records have been manually altered using [ ARTAX.E ](../../../../rover/AR-OVERVIEW/AR-ENTRY/ARTAX-E/index.md) .   
