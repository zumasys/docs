...
**Form Details**  
[ Form Details ](CASH-R3-1/index.md)   

**Purpose**  
The [ CASH.R1 ](../../../../rover/AR-OVERVIEW/AR-REPORT/CASH-R1/index.md) procedure is used to print a cash receipts / check register for a selected deposit number. The deposit number is a user-defined field which can be used to "batch" cash receipts. 
