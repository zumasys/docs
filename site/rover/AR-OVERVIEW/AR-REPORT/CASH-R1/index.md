...
**Form Details**  
[ Form Details ](CASH-R1-1/index.md)   

**Purpose**  
The CASH.R1 procedure is used to print a cash receipts / check register for a selected period. The report has an option to include miscellaneous cash receipts processed through [ CASH.E3 ](../../AR-ENTRY/CASH-E3/index.md) . Miscellaneous cash receipts should be excluded when using this report as a balancing tool. 
