...
**Form Details**  
[ Form Details ](CUST-R4-1/index.md)   
...
**Start Date** The date this customer started doing business with your company. This date will only appear on the report if it was entered in the [ CUST.E ](../../AR-ENTRY/CUST-E/index.md) procedure.   
**Credit Hold** A "Y" will appear in this column if the customer was placed on credit hold in [ CUST.E ](../../AR-ENTRY/CUST-E/index.md) .   
...
**Day Limit** The number of days you consider an invoice past due. This field can be set by customer in [ CUST.E ](../../AR-ENTRY/CUST-E/index.md) . If no entry is made in [ CUST.E ](../../AR-ENTRY/CUST-E/index.md) , the report will use the past due days field in [ AR.CONTROL ](../../AR-ENTRY/AR-CONTROL/index.md) .   
