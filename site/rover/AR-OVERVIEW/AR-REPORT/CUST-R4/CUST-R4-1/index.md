...
**Past Due Invoices** Check this box if you only wish to include customers with past due invoices. For purposes of this report, the invoice is considered past due if it exceeds the day limit referenced in [ CUST.E ](../../../AR-ENTRY/CUST-E/index.md) or [ AR.CONTROL ](../../../AR-ENTRY/AR-CONTROL/index.md) .   
  
**No Dollar Limit** Check this box if you only wish to include customers for which no dollar or credit limit has been defined in [ CUST.E ](../../../AR-ENTRY/CUST-E/index.md) .   
