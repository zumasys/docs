...
**Sort By** If you wish to sort this report by AR Id (invoice number), enter 'I'. To sort by date, enter 'D'. To sort by customer name, enter 'C'. This field defaults depending upon whether you are assigning sequential invoice numbers in the [ MRK.CONTROL ](../../../../MRK-OVERVIEW/MRK-ENTRY/MRK-CONTROL/index.md) procedure.   
