...
**Year** Enter the year in four digits (e.g. 2005) that you wish to run this
report for. If left blank, the current year will be used.  
  
**Customer** Enter the customers you wish to run this report for. If left
blank, all customers will be included.  
