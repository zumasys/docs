...
**Form Details**  
[ Form Details ](AR-R10-1/index.md)   
...
**Next.Action** The next action date that has been entered in the [ AR.E ](../../AR-ENTRY/AR-E/index.md) screen for this AR item.   
**Status** The current collection status that has been assigned to this AR item in [ AR.E ](../../AR-ENTRY/AR-E/index.md) .   
**Status.Description** The description of the collection status code, as read from the [ ACCT.CONTROL ](../../../../rover/AP-OVERVIEW/AP-ENTRY/ACCT-CONTROL/index.md) screen.   
