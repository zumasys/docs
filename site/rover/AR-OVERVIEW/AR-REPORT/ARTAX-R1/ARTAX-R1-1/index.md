...
**State** If you wish to run this report for selected states, enter the state code(s). These state codes must exist in the [ STAX.E ](../../../AR-ENTRY/STAX-E/index.md) records for this field to have an impact.   
