...
**Inactive Reps Only** Check this box if you wish to run the report for inactive reps only. It is recommended that you select this optoin after inactivating a rep so that the rep id can be removed, if required, from the customer records via [ CUST.E ](../../../AR-ENTRY/CUST-E/index.md) .   
