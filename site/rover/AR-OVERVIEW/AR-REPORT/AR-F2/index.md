...
**Form Details**  
[ Form Details ](AR-F2-1/index.md)   

**Purpose**  
The AR.F2 procedure is used to print / re-print invoices on blank paper or letterhead. Any AR item, whether it came from the shipments process, was entered through [ AR.E ](../../AR-ENTRY/AR-E/index.md) , or was created through [ ARR.P1 ](../../AR-PROCESS/ARR-P1/index.md) may be selected and printed. If invoices are printed using the [ SHIP.F2 ](../../../MRK-OVERVIEW/MRK-REPORT/SHIP-F2/index.md) procedure, then the AR.F2 process need only be run when a re-print of an invoice is required. 
