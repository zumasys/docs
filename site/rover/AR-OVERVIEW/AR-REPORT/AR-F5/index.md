...
**Prerequisites**  
The aging periods and column headings must be established in the [ AR.CONTROL ](../../AR-ENTRY/AR-CONTROL/index.md) record.   
...
**Aging** The total amount due, aged over the periods as defined in the [ AR.CONTROL ](../../AR-ENTRY/AR-CONTROL/index.md) record.   
