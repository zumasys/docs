...
- [Header](AR-E-1/index.md)
- [Line Items](AR-E-2/index.md)
- [Register History](AR-E-3/index.md)
- [Ship Address/Credit Card](AR-E-4/index.md)
- [Attachments](AR-E-5/index.md)
- [Collections](AR-E-6/index.md)
- [Change History](AR-E-7/index.md)

**Purpose**  
The AR.E procedure is used to enter or update Account Receivable records/invoices. In addtion to creating new invoices, records created from sales order shipments, RMA receipts or FSO records can be accessed and edited in this procedure. Invoices or credits created from [CASH.E](../CASH-E/index.md) may also be viewed in this procedure but changes are not permitted to them. If a change is required, the original cash record must be reversed or an offsetting AR record created.
...
**Prerequisites**  
Entry of valid customers ([CUST.E](../CUST-E/index.md)). Entry of valid general ledger account numbers ([GLCHART.E](../../../GL-OVERVIEW/GL-ENTRY/GLCHART-E/index.md)). Entry of part numbers if they are to entered ([PARTS.E](../../../ENG-OVERVIEW/ENG-ENTRY/PARTS-E/index.md)).
