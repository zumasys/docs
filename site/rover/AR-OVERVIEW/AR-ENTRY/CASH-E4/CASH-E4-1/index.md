...
**Customer Name** The name of the customer as it appears in [ cust.e ](../../CUST-E/index.md) .   
...
**Deposit Id** This field is used to assign a "deposit batch" number to a series of cash entries. These cash entries may then be reported as a group. Deposit slips may ,also, be printed via [ CASH.F1 ](../../../AR-REPORT/CASH-F1/index.md) . If you will be using [ RECON.E ](../../RECON-E/index.md) to reconcile your bank statements, a deposit id is recommended.   
