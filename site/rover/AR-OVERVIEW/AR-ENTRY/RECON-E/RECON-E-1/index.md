...
2\. Verify that all journal entries have been posted to the g/l. You can run [ GLTRANS.R2 ](../../../../GL-OVERVIEW/GL-REPORT/GLTRANS-R2/index.md) to view any un-posted transactions.   
