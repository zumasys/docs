...
**AR Acct#** Enter the G/L account number against which the AR records will be charged. This account number is defaulted from the [ AR.CONTROL ](../../AR-CONTROL/index.md) file and can be changed if necessary.   
...
**Invoice Date** Displays the date on which the invoice was created by the [ ARR.P1 ](../../../AR-PROCESS/ARR-P1/index.md) process.   
