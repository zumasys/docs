...
- [Data Entry Procedures](AR-ENTRY/index.md)
- [Reports and Inquiries](AR-REPORT/index.md)
- [Update Processes](AR-PROCESS/index.md)
...
**Setup Procedures**  
There are three setup processes which must be performed prior to beginning the normal flow of activities. The first is the definition of the terms codes ( [TERMS.E](../../rover/AP-OVERVIEW/AP-ENTRY/TERMS-E/index.md) ). While additional codes may be added at any time, the codes you intend to use immediately must be available. Customer records must also be entered ( [CUST.E](AR-ENTRY/CUST-E/index.md) ) for at least the customers which you intend to use immediately, the rest may be added as required. The accounts receivable control record ( [AR.CONTROL](AR-ENTRY/AR-CONTROL/index.md) ) must also be setup before normal activities may begin.
  
Optionally, you will need to set up the sales tax code file ( [STAX.E](AR-ENTRY/STAX-E/index.md) ) if you wish to track detail sales tax history by district.

**Flow of Activities**  
The flow of processing for the accounts receivable module can begin in any one of three places. First, items which are shipped through the Marketing module create AR records. Second, AR items may be entered directly through [AR.E](AR-ENTRY/AR-E/index.md) for non-shipment items. Third, items may be created automatically by the [ARR.P1](AR-PROCESS/ARR-P1/index.md) batch recurring entry procedure. This will create AR items for all eligible recurring ARR item. Once the item is present in the AR file, it may be paid through the [CASH.E](AR-ENTRY/CASH-E/index.md) procedure. The invoice printing process ( [AR.F1](AR-REPORT/AR-F1/index.md) or [AR.F2](AR-REPORT/AR-F2/index.md) ) may be used to print or re-print any invoices.
  
The maintenance of the Customer file ( [CUST.E](AR-ENTRY/CUST-E/index.md) ) and the Terms file ( [TERMS.E](../../rover/AP-OVERVIEW/AP-ENTRY/TERMS-E/index.md) ) should be done as new items are required or changes need to be made.
  
At some point in time it may be appropriate purge some of the older accounts receivable and cash records from the system. This is done with the [AR.P3](AR-PROCESS/AR-P3/index.md) and [CASH.P1](AR-PROCESS/CASH-P1/index.md) procedures.
