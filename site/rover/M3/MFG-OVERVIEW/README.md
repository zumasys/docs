...
The PLAN control record ([PLAN.CONTROL](./README.md)) must be setup if
...
The CRP control record ([CRP.CONTROL](./README.md)) must be setup if you
...
using [PARTS.E](./README.md). Another procedure in the Engineering module that
is required is [PARTS.P4](./README.md) which sets the low level codes for all
part numbers. This process must be run at least once before
[MPS.P1](./README.md) or [MRP.P1](./README.md) are run, and must be rerun any
time the bill of material structure is changed. For this reason the
[PARTS.P4](./README.md) procedure is usually included in the nightly batch
process before [MPS.P1](./README.md) and [MRP.P1](./README.md).
...
defined using the [PB.E](./README.md) procedure. Once defined they may be used to
generate sales forecast or master schedule items using the [PB.P1](./README.md)
procedure.
...
entered manually using [SF.E](./README.md). Even if you generated the forecast
from the Planning Bills you may adjust individual items with [SF.E](./README.md).

Entering Master Schedule items is the next step, although it may also be an
ongoing process. Master Schedules are entered with the [MS.E](./README.md)
procedure. Even if they were created through Planning Bills, you may still
adjust Master Schedule items with [MS.E](./README.md).
...
running the [MPS.P1](./README.md) procedure. Unlike the previously described
...
procedures. [MPS.R1](./README.md) is used to run reports against the MPS based
on exceptions calcuated by the system. This allows you to focus on areas that
need attention without reviewing every MPS item. The [MPS.Q](./README.md)
inquiry is used to look at details about individual MPS items such as demand
pegging. The [MPS.Q](./README.md) inquiry is usually used in conjuction with the
[MPS.R1](./README.md) report by those who are monitoring and making adjustments
...
Another option available to the planner is the [PLAN.E](./README.md) procedure.
...
the [ID.E](./README.md) procedure. This allows you to add demand for specific
...
done by running the [MRP.P1](./README.md) procedure. This process is usually
...
[MPS.P1](./README.md) process is run before [MRP.P1](./README.md) so that the
output from MPS will be availble to MRP.

Once the MRP report files are available you can run the reporting and inquiry
procedures. [MRP.R1](./README.md) is used to run reports against the MRP based
on exceptions calcuated by the system. This allows you to focus on areas that
need attention without reviewing every MRP item. The [MRP.Q](./README.md)
inquiry is used to look at details about individual MRP items such as demand
pegging. The [MRP.Q](./README.md) inquiry is usually used in conjuction with the
[MRP.R1](./README.md) report by those who are monitoring and making adjustments
...
[INV.R5](./README.md) report. This report always utilizes current inventory
...
The first step in capacity planning is to run the [CRP.P1](./README.md)
procedure. This process builds the CRP files required for the reporting. If
you chose the option in the [CRP.CONTROL](./README.md) procedure that
...
capacity is consumed as orders are added. [CRP.P1](./README.md) is usually run
...
[CRP.R1](./README.md) or the inquiry [CRP.Q](./README.md).
...
date. The procedures that perform these purges are [SF.P1](/README.md) (Sales
Forecast), [ID.P1](./README.md) (Independent Demand), [MS.P1](./README.md) (Master
Schedule), and [PB.P2](./README.md) (Planning Bills).
