...
**1\. Min 2. Max 3. Both**|  Enter one of the following numbers to denote
which items are to be included in the report.

1\. All parts below the minimum stocking level (i.e. safety stock).
2\. All parts above the maximum stocking level.
3\. All parts below minimum or above maximum.

**Buyer**|  If you want to restrict the listing to include only parts for a
specific buyer then enter the code that identifies the buyer in this field. If
left blank then all items regardless of buyer will be included.

**Planner**|  If you want to restrict the listing to include only parts for a
specific planner then enter the code that identifies the planner in this
field. If left blank then all items regardless of buyer will be included.

**Plan Group**|  Enter the planning group for which you wish to run this
report.

**Vendor**|  Enter the vendor number to use when selecting parts to be
displayed.

**Category**|  If you want to limit the listing to specific part categories
then enter each category to be included. Leave the field blank to process all
categories.
