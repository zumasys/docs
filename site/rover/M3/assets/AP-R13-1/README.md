...
**End Date**|  Enter the start date range within which the invoice date for
the freight bill must fall to be selected for this report. Leaving this field
null assumes you wish to select all invoices since the start date entered.
