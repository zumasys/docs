...
**Detail**|  If you wish to show each line of detail from the ARREG file,
enter 'D'. If you wish to summarize the detail into one line per account,
enter 'S'. If you leave this field null, detail is assumed.

**Co Code**|  Enter the company codes you wish to include in this report. If
...
**Account Number**|  If you wish to run this report for specific accounts,
enter the g/l account numbers in this field.

**Account Description**|  This field contains the description of the account
number.
