...
**Shortages Only**|  Check this box if you want to include only those items
with a projected shortage.
...
**Release Date**|  If you selected option "M" in the previous prompt you may
...
**Plan Group**|  Enter the planning group you wish to use for this report.
This will control the MRP quantities used and the available inventory
locations.
