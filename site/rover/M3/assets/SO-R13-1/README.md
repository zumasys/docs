...
**Start Date**|  If you wish to limit this report to sales orders with
schedule dates greater than or equal to a certain date, enter that date in
this field. If you wish all sales orders to be included, leave this field
blank.

**Cutoff Date**|  If you wish to limit this report to sales orders with
schedule dates less than or equal to a certain date, enter that date in this
field. If you wish all sales orders to be included, leave this field blank.

**Company Code**|  If you wish to run this report for specific companies,
enter the company codes in this field.
