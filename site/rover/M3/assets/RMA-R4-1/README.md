...
**Customer#**|  Enter the number of the customer that you want to include in
the report. If you do not know
the customer number, there is an option in the help menu for this prompt which
allows you to
select the customer by name.
...
**Status**|  If you only wish to run this report for RMA records with an open
status, enter OPEN in this field. If you wish to run the report for RMA
records that have been closed, enter CLOSED in this field. If you wish to
include both open and closed items on the report, leave this field blank.
