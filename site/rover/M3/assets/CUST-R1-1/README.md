...
**Start Date**|  If you wish to select customers based on sales criteria,
enter the starting sales date in this field. If a start date, end date or
sales amount is entered only customers that match the selected sales criteria
...
**Exclude Inactive Customers**|  Check this box if you wish to exclude
inactive customers. If this box is checked, any customer for which an inactive
date was entered in [CUST.E](../CUST-E/README.md) will not be included in this report.
