...
**Blanket Period From**|  If required, enter the date that should appear in
the BLANKET PERIOD FROM field on the form.

**Blanket Period To**|  If required, enter the date that should appear in the
BLANKET PERIOD TO field on the form.

**Preference Criterion**|  Enter the preference criterion that should appear
on this form for each part number.

**Country of Origin**|  Enter the country of origin that shoudl appear on this
form for each part.

**Producer**|  Enter the data that should appear in the PRODUCER field for
each part number listed on the form.
