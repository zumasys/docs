...
**Route Number**|  Enter all of the route shipments you want to have printed,
or enter a date range of load dates to print all route shipments of a certain
date.

**Load Date**|  Enter the load date associated with the route.

**Start Date**|  Enter the start date, if you wish to print a range of route
shipments by date. The date which is entered here is the load date of the
routeship record.

**End Date**|  Enter the end date if you wish to print a range of route
shipments by date. The date which is entered here is the load date of the
routeship record.
