...
**Work Order Number**|  The work order number entered at this prompt
determines which transactions will be included in the listing. Only those
transactions which show the work order entered as the origination work order
will be included.
