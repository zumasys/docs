...
**Aging Method**|  This prompt determines which method is used to run the
aging report. There are three options:
...
**Customer#**|  Enter a customer number if you wish to run the aging report
for that customer only. Otherwise,
