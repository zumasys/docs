...
**Location**|  Enter the inventory location for which you wish to run this
report.

**Location Desc**|  The description of the selected inventory location as
found in the INVLOC file.
