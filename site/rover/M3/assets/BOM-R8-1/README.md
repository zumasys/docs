...
**C$X47**|  Enter the date to use in determining which items on the bills of
material are to be included in the report. This date will be compared to the
start and end effectivity dates on each component.

**Plan Group**|  Enter the plan group to be used to determine the part number
lead times.
