...
If you only wish to post journals that were generated from the register files,
enter REGISTER in this field. These journal entries are created via
[GLINT.P1](../GLINT-P1/README.md).

If you only wish to post miscellaneous/manual journals, enter GLTRANS in this
field. These journal entries are created via [GLTRANS.E](../GLTRANS-E/README.md),
[GLRECUR.P1](../GLRECUR-P1/README.md) and [RECON.E](../RECON-E/README.md).
