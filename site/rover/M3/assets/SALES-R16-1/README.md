...
category. If this option is selected, the report will contain the totals for
each category.

**Category**|  If you only want to list the sales for a particular category,
then enter the category in this field. To include all categories, leave this
field empty.
...
**Include Receipts**|  Check this box if you wish to include the quantities
and amounts received against a purchase order for the selected time period.
