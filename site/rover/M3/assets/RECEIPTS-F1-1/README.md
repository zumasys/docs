...
address printed on the page.

**Debit Receipt Numbers**|  Enter the numbers of all of the debit receipts to
be printed. The format of the number should be the PO number followed by a
dash (-), followed by a 'D' and a sequential number. Example - 45340-D2.
