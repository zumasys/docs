...
| **Change Date**|  The date the PRICE record was changed. This is only stored
...
**Changed By**|  The User ID of the person who changed the price record. This
...
also be included in price record change notices sent by email.

**Change Notes**|  Enter any notes associated with changes made on this date
and time. These notes will also be included in price record change notices
sent by email.
