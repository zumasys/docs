...
**C$X38**|  If you wish to show each line of detail from the WOREG file, enter
'D'. If you wish to summarize the detail into one line per account, enter 'S'.
If you leave this field null, detail is assumed.

**Account Number**|  Enter the account number for which you would like this
...
**Acct Description**|  This field contains the account description from the
GLCHART file.
