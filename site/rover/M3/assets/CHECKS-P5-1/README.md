...
**Void Date**|  Enter the date that should be used to void or delete the
check. This is the date that will be posted to the accounts payable register
file and ultimately the general ledger. If the date on the check is greater
than this date, the check will not be voided or deleted.
