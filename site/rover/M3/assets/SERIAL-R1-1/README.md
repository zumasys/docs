...
**Part Number**|  Enter the part number for which you wish to list the serial
numbers shipped/received.

**Customer Number**|  If you want to list the serial numbers for a specific
customer, then enter the customer number in
this field. There is also an option available in the help menu that allows you
to select the
customer by name.

**Start Date**|  If you want to limit the report to include only items that
have activity within a date range, you may specify a start and/or end date
range. The starting date is entered in this field.

**End Date**|  If you want to limit the report to include only items that have
activity within a date range, you may specify a start and/or end date range.
The ending date is entered in this field.

**Customer Name**|  Contains the name associated with the customer number
entered.
