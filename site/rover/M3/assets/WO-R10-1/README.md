...
**Start Date**|  If you wish to run this report for a date range, enter the
starting date in this field.

**End Date**|  If you wish to run this report for a date range, enter the
ending date in this field.

**Date Option**|  Enter the date you wish to use when selecting records. The
valid entries are listed below. If no entry is made in this field, the
completion date will be used.

1\. Wo Date - The date the work order was created.
2\. Required Date - The date the work order was scheduled to be completed by.
3\. Completion Date - The date the work order was completed. Please note that
if partials completions were made against the work order, the last completion
date will be used. Only workorders that have been 100% completed will be
included in this report.

**Category**|  If you wish to run this report for specific categories of
parts, enter the category codes in this field.

**Wip Location**|  If you wish to run this report for specific work in process
locations, enter the location codes in this field.

**Part Number**|  Enter the part numbers you wish to include in the report.
Leave this field blank to include all parts.
