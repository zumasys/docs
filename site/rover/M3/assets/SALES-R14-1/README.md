...
**Last Year Start**|  Enter the start date for the previous year.

**Last Year Month Start**|  Enter the start date for the month in the prior
year.

**Last Year Cutoff Date**|  Enter the date to be used as the year-to-date
cutoff date in the prior year calculation.

**Year Start**|  Enter the start date for the current year.

**Month Start**|  Enter the start date for the month in the current year.

**Cutoff Date**|  Enter the date to be used as the year-to-date cutoff date in
the current year calculation.

**Co Code**|  Enter the company code for which you wish to run this report.

**Customer**|  If you wish to limit this report to certain customers, enter
the customer numbers in this field.

**Customer Code**|  Enter the customer code(s) to include in this report.
Leave this field empty to include all codes.
