...
**Start Date**|  If you wish to reprint all invoices which for a range of
dates, enter the startng date for the range.

**End Date**|  If you wish to reprint all invoices which for a range of dates,
enter the endng date for the range.

**Starting Invoice**|  If you wish to reprint all invoices which for a range
of invoice numbers, enter the starting number for the range.
