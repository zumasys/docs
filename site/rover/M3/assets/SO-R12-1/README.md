...
**Past Due Date**|  Enter the date which is to be considered "past due" for
the purposes of this report. All dates on or before this date will be
identified as "past due" on the report. All dates after this date will display
the actual date of the schedule.

**Cust Nbr**|  Enter the customer number if you want to limit the report to
one customer.
