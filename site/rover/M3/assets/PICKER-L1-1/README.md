...
**Work Order Numbers**|  Enter the work order numbers you would like to
display or print.
...
**Part Number**|  If you only wish to print labels for specific parts, ente
rhe part numbers in this field. If no entry is made in this field, labels will
print for all parts called out for on the picklist.

**Non-label Output**|  Check this box, if you wish to print on a standard 3
1/2" x 15/16" continuous form label.
