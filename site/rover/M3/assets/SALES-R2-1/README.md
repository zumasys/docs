...
**Sort by P)art or M)odel**|  Select the method you wish to sort the report
by. The options are category, model and part number. If no selection is made
in this field, the report will sort by part number.

**Description Options**|  If you wish to print the full part description on
the report, enter FULL DESCRIPTION in this field. To only print the first line
of description, enter FIRST LINE. To print no description, enter NO
DESCRIPTION or leave this field blank.

**Part Number**|  If you only want to list the sales for particular part
numbers then enter the part numbers in this field. To include all part numbers
leave the field blank. If you do not know the part number you may enter a
model number, part category or manufacturer part number to find the number.

**Part Description**|  This field contains the first line of description of
the part number entered. It may not be changed.

**Category**|  If you wish to run this report for specific categories of
parts, enter the category codes in this field. If no entry is made in this
field, all categories will be included.
