...
**Ship#**|  Enter the ship number(s) for which you wish to print a shipping
pick list. If you want all eligible shippers, leave this field null.

**Sequence**|  Enter "B" to print in bin sequence. Enter "P" or leave blank
for picklist sequence (default).

**Include Phantoms**|  Check this box to include phantoms. Leave blank to
exclude phantoms.

**Co Code**|  If you are not printing specific shippers then enter the company
codes you wish to appear on this report. If left blank all company codes will
be included.
