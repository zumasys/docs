...
**Use Build Date**|  Check this box to use the build date against the date
range criteria.
...
that contain specific software components. You would enter each item to
include in this field. For example, if you wanted to include any records that
referenced the FDICT record for the parts file you would enter "PARTS". For a
procedure you would enter a procedure name such as [PARTS.E](../PARTS-E/README.md). For
a program you would enter a program name such as P$PARTSE.
