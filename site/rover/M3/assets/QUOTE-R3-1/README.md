...
**Prospect#**|  Enter the number of the prospect that you want to include in
the report. If you do not know the prospect number, there is an option in the
help menu for this prompt which allows you to select the prospect by name.

**Cust Name**|  The customer name as it appears in the customer file.
