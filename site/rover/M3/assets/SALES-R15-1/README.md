...
**Exclude Totals**|  Check this box if you do not wish to print the total
lines on the report. This option is usually selected when sending the report
to Excel or the grid viewer.

**Category**|  Enter the part categories you wish to include in this report.
If left blank, all categories will be included.
...
**Pat Description**|  This field contains the first line of description for
