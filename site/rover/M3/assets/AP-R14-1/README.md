...
made in this field, the report will be sorted by the invoice date.

**Exclude Totals**|  Check this box if you wish to exclude totals from the
report.

**Vendor**|  Enter the vendor numbers you wish to include in this report.
Leave this field blank to include all vendors.

**Ap Ids**|  Enter the accounts payable id(s) you wish to include in this
report. Leave this field blank to include all invoices.
