...
**Cycle Date**|  Enter the cycle date for which you wish to run this report.
All tags for this date will be selected.

**Plan Group**|  Enter the plan group for the cycle count that you want to
cancel. Leave blank to cancel all cycle counts for the date selected.
...
**Inventory Location**|  If you only wish to cancel the cycle count for
specific locations, enter those locations in this field. If you wish to cancel
the cycle count for all locations, no entry is required in this field.
