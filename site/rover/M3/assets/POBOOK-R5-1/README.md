...
**Vendor Number**|  If you only want to list the bookings for a particular
vendor then enter the vendor number in this field. To include all vendors
leave the field blank. If you do not know the vendor number, there is an
option in the help menu for this prompt which allows you to select the vendor
by name.
...
**Exclude Totals**|  Check this box if you wish totals to print on the report.
This option is most commonly selected when sending the data to Excel or the
grid viewer.
