...
**Type**|  Enter all of the ECN type codes you want to include in the listing.
To include all type codes leave this field blank.

**Status**|  Enter the status codes to be used in determining which ECNs are
include in the listing. To include all status codes leave this field blank.
