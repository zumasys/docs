...
**Cutoff Date**|  Enter the cut-off date to be used in selecting the items for
...
**Status**|  If you wish to limit this report by status, enter the work order
status' to include in the report. If an entry is made in this field, the
'include closed orders' option is ignored.

**Include Closed Orders**|  Check this box if you wish to include closed and
open orders on this report. Leave unchecked to show only open work orders. A
closed order is defined as a work order having a status of "C" or "F". Open
work orders are defined as any status other than "C" or "F".
