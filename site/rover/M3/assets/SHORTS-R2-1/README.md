...
**Cutoff Date**|  If a date is entered in this field, only shortages created
for work orders scheduled to be completed on or before this date will appear
on the report. Leave this field blank to include all shortages.
