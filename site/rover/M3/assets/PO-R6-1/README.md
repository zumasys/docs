...
**Start Date**|  You may limit the items included in the listing by specifying
a start and/or end date. Any purchase order that has a close date less than
the start date will be excluded from the listing.
