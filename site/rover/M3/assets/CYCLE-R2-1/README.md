...
**Status to Include**|  Enter the status codes you wish to appear on this
report. The valid options are :
N=Uncounted C=Counted V=Void
or leave this field null to print all tags.

**Cycle Date**|  Enter the cycle date for which you wish to print an audit
report. If you wish to list tags for all dates, leave this field null.
...
**Inventory Location**|  If you wish to limit this report to certain
locations, enter the locations in this field.
