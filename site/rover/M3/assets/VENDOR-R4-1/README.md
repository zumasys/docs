...
**Vendor(s)**|  Enter the number(s) of the vendors for which you
want to print an activity report. You may enter
multiple vendor numbers, or leave this field null
to print listings for all vendors which have AP
records on file. If you do not know the number
for a particular vendor, there is an option in the
help menu for this prompt which allows you to
select the vendor by name.
