...
**Update PD**|  Check this box if the PD records are to be updated with the
new maximum entry.

**Create Mod**|  Check this box if you want the procedure to create a record
in the MOD file detailing the PD records change. This option is only valid if
the update option in the previous prompt is also checked.
