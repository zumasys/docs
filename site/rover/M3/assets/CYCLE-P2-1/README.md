...
**Register Date**|  Enter the date which will be placed into the INVREG
records which are created by this procedure. This date will determine into
which accounting period the inventory movements will fall.
