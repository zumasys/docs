...
**State**|  Enter the state(s) you wish to run this report for. If this field
is left blank, all states will be included.

**Use Customer State**|  Check this box, if you wish to base this report on
the primary address for the customer as opposed to the ship to state. The
primary and/or main address for a customer is defined on the general tab in
[cust.e](../Cust-e/README.md). If this box is not checked, the state that the product
was shipped to will be used. This state can be found on the address tab in
[ar.e](../Ar-e/README.md).
