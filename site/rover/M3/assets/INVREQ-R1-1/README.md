...
**Status**|  Enter the letter "O" to list only requisitions that are still
open, "C" to list only those that are closed, or "A" to include all
requisitions. Leaving the field empty will be treated as if an "A" were
entered.
