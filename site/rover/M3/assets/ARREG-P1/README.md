...
**Purpose**
The [ARREG.R1](../ARREG-R1/README.md) procedure is used to purge ARREG records from the
data base. The criteria used to deterime which records are purged is based on
a user defined cut-off date. All ARREG records which have a posted date that
is less than or equal to the cut-off date will be deleted. The post date
indicates that the record was posted to general ledger.
