...
**Run#**|  Enter the check run number for which you wish to select records for
this report. Leave this field null to select all Prechecks records on file.
...
**Print Summary**|  Check this box to print a summarized version of this
report. The detail version of the report will display all commission records
scheduled to be paid to a rep. The summary version only displays the total
amount to be paid to each report.
