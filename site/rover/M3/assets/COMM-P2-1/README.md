...
must fall to have the eligible amount marked as paid. You may leave the field
blank if you do not want to limit the range with a start date.

**End Date**|  Enter the end range date within which the commission date must
fall have the eligible amount marked as paid. You may leave this field blank
if you do not want the range to be restricted by an end date.

**Date Paid**|  Enter the date to be posted as the date paid in the commission
records. If no date is entered then the current date is assumed.

**Rep Number**|  If you only want to mark the commissions for a particular rep
