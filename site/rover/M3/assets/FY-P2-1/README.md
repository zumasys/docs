...
**Fiscal year**|  Enter the date of the fiscal year which you want to
"finally" close. Remember, this procedure should only be run after all
adjusting journal entries have been completed. No transactions will be allowed
into the fiscal year after this process runs.

**Final msg**|  A final warning message is loaded into this field to warn the
operator of the impact of running this procedure.
