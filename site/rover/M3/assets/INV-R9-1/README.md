...
**Invloc**|  Enter the inventory location for which you wish to list bins.

**Print Lots?**|  Check this box if you want the lot numbers to print on the
report for lot controlled parts.

**Exclude Totals**|  Check this box if you wish to exclude totals from the
report.

**Bin Location**|  Enter the bin location(s) for which you wish to run this
report. Leave this field empty to print all bins.
