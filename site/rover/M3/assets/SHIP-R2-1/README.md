...
**End Date**|  Enter the ending date to be used in this report. If this field
is not left blank, all open records with a date <= to this date will be
selected.

**Customer**|  Enter the customer number(s) you wish to include in this
report. If this field is left blank, all customers will be selected.
