...
**Start Date**|  Enter the the starting date for the period that is to be
listed. All work orders with a closed date prior to the date entered will be
excluded.

**End Date**|  Enter the the ending date for the period that is to be listed.
All work orders with a closed date after the date entered will be excluded.

**Part Number**|  If you want to limit the listing to work orders for a
specific assembly, then enter the assembly number in this field. If you leave
this field blank then all assemblies are included.
...
**Work Order**|  Enter the work orders you wish to include in this report.
Leave this field blank to include all work orders.
