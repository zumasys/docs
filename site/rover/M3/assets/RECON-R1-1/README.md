...
**Bank Account**|  This field contains the bank account number from the Recon
ID entered and is for reference only.

**Month Start**|  This field contains the month start date from the Recon ID
entered and is for reference only.

**Month End**|  This field contains the month end date from the Recon ID
entered and is for reference only.
...
**Un-Cleared Checks?**|  Set this field if you wish to include un-cleared
checks on the report.

**Adjustments?**|  Set this field if you wish to include adjustments on the
report.

**Summary?**|  Set this field if you wish to include the summary balance page
on the report.
