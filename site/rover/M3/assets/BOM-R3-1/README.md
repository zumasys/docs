...
**Display Full Description**|  Check this box if you wish to display the
entire description for both the assembly and component parts. If this box is
not checked only the first line of description will appear on the report.
