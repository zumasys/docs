...
**Start Date**|  Enter the start date range within which the post date must
...
**End Date**|  Enter the end date range within which the post date must fall
...
**Co Code**|  Enter the company codes you wish to include in this report.
