...
**Cust Number**|  Enter all of the customer numbers you want to have included
on the report or leave this field blank to include all customers.

**Status**|  You may restrict the items included on the report to the status
you specify in this field. Leave the field blank to include all types.
