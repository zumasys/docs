...
**Planner Codes**|  Enter the planner codes you wish to have selected for the
report. If you leave this field blank then the listing will include all
shortages in planner code sequence.
