...
**Start Date**|  Enter the date you want to use as the first date for
determining the horizon. The horizon days are added to this date to determine
how far into the future the system should look to include items in the report.

**Horizon Days**|  Enter the number of days you want to add to the start date
to determine the report horizon.

**Work Centers**|  Enter all of the work centers for which dispatch listings
are to be created. If you leave this field blank then all work centers will be
listed.
...
**Status**|  If you only wish to select work orders with certain status',
enter those status codes in this field. The valid entries are: NEW, OPEN,
RELEASED, PULLED and STARTED.
