...
**Effective Date**|  Enter the effectivity date to be used for determining
which items are included in the report. The start and end effectivity against
which this date is compared, is taken from the bill of material records.
