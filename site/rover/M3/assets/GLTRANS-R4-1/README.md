...
**Starting Number**|  Enter the starting number of the range of numbers you
want to list on the report. If left blank then all numbers up to the end
transaction number specified will be included.

**Ending Number**|  Enter the ending number of the range of numbers you want
to list on the report. If left blank then all numbers beginning with the
starting transaction number specified will be included.
