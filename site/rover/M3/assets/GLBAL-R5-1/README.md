...
**Cutoff Date**|  Enter the date you wish to use as the cutoff date. The
account balance calculated will be as of this date.
...
**G/L Account**|  Enter the GL account number for which you wish to calculate
a balance.
