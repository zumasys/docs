...
enter that group ID here. Leave this field empty to print all planning groups.

**Cutoff Date**|  If you wish to limit this report to purchase orders through
a given date, enter that date in this field. Open purchase orders with a
schedule date less than or equalt to the date entered in this field, will be
included in the report.

**Co Code**|  Enter the company codes you wish to appear on this report. If
left blank all company codes will be included.

**Summary Report**|  Check this box if you wish to print a summary report by
vendor. This report displays the total dollars and quantities open by vendor.

**Print Entire Description**|  Check this box if you wish the entire part
description to appear on the report.

**Exclude Totals**|  Check this box if you wish to exclude the totals from the
report. This option is most commonly used when exporting the data to Excel or
the grid viewer.
