...
starting date in this field. If a date range is entered, only RMA records that
have a assigned date that falls within the date range will be selected.

**End Date**|  If you wish to limit this report to a date range, enter the
ending date in this field. If a date range is entered, only RMA records that
have an assigned date that falls within the date range will be selected.
