...
**Start Date**|  Enter the start date for displaying total usage for the
period.
...
2\. Category
3\. Inventory Location (as set-up in [parts.e](../Parts-e/README.md))
...
**Inventory Location**|  Enter the inventory locations (as defined in
[Parts.e](../Parts-e/README.md)) to be used in this report. If left blank all locations
will be included.
