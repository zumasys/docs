...
**End Date**|  The start date and end date are used to limit the items
included in the listing. Any allocation with a date greater than or equal to
the start date, and less than or equal to the end date will be included in the
report. If you do not enter an end date then all items through the greater
than or equal to the start date will be included in the report.
...
**Part Number**|  Enter the part numbers you wish to include in this report.
If left blank all numbers will be included.

**Exclude Totals**|  Check this box if you do not wish to included totals in
the report. This option is most often selected when exporting data to Excel or
the grid viewer.
