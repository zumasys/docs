## Work Order Material Adjustment Purge Process (WOMATL.P1)
<PageHeader />

**Form Details**
[Form Details](../WOMATL-P1-1/README.md)

**Purpose**
The WOMATL.P1 procedure is used to purge work order material adjustment
records from the data base. The criteria used to deterime which records are
purged is based on a user defined cut-off date. All transaction records which
have a post date that is less than or equal to the cut-off date will be
deleted.
