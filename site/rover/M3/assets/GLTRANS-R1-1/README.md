...
**Start Date**|  Enter the starting transaction date you wish to appear on
this report (i.e. the first of a range of dates). Leave this field null to
list all journal transactions from the beginning.
...
1\. Gltrans - Journal entries created in [GLTRANS.E](../GLTRANS-E/README.md).
2\. Recon - Journal entries created via [RECON.E](../RECON-E/README.md).
2\. Recurring = Recurring journal entries created via
[GLRECUR.P1](../GLRECUR-P1/README.md).
3\. Register - Journal entries created from one of the four reigster files
(APREG, ARREG, INVREG and WOREG) via the [GLINT.P1](../GLINT-P1/README.md) procedure.
