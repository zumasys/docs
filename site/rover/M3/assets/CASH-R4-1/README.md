...
**Customer**|  Enter the number of the customer for which you wish to run this
...
**Exclude Totals**|  Check this box if you do not wish to include the totals
or the distribution summary by account on the report. This is sometimes
helpful when exporting the data to excel.
...
**Name**|  This field contains the customer name, as it appears in the CUST
file.
