...
in the report. All service orders
that were completed on or before the end date will be included.

**Include Open Orders**|  Check this box if you wish to include open orders in
this report.

**Employee Number**|  Enter the employee number(s) that you want to include in
the report, or leave blank to include
all employees.
