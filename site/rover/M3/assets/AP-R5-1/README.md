...
report. Any invoices with dates to pay after this date will not be included.

**Exclude CC Invoices**|  Check this box if you wish to exclude invoices that
are scheduled to be paid by credit card from the report. Please note that the
system uses the terms code to determine if the invoice is scheduled to be paid
by credit card. You would use the [TERMS.E](../TERMS-E/README.md) procedure to flag a
terms code as a credit card type term. If you do not have access to this
procedure, please contact your administrator.

**Force Discount**|  Check this box if you wish to take a discount on all
