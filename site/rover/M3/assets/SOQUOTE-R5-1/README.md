...
**Start Date**|  Enter the range start date to be used for this report.

**End Date**|  Enter the range end date to be used for this report.

**Status**|  Enter the status code which you wish to include on this report.
Leave this field empty to include all status codes. Enter the word "NONE" if
you wish to run this report for all quotes for which no status has been
entered.

**Rep**|  Enter the rep(s) for which you wish to run this report. If left
blank all reps will be included.

**Name**|  The name of the rep as is appears in the rep file.
