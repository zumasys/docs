...
**Co Code**|  Enter the company code you wish to create checks for. If only
one company code exists it will automatically be inserted into this procedure
for you.
...
CONTROL/README.md) file but can be changed as required. If no entry is made in this
field, the account entered in the [AP.CONTROL](../AP-CONTROL/README.md) record will be
used.
...
**Amt to Pay**|  This field contains that amount to pay for the associated
comm id. This amount will initially be set to the eligible amount but can be
