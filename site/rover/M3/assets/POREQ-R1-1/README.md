...
**Cut-off Date**|  If you want to limit the listing to only include
requisitions dated through a specific date, then enter that date here.
Otherwise leave this field blank.

**Plan Group**|  If you wish to print this report for a selected planning
group, enter that group here. To print all requisitions, leave this field
empty.

**Status**|  Enter the letter "O" to list only requisitions that are still
open, "C" to list only those that are closed, or "A" to incluse all
