...
**Assembly**|  Enter the assembly number for which you wish to re-load the
data into the Picker and Woinv records. Leave this field empty to load all
work orders with a status of "R".

**Desc**|  This field contains the description of the associated assembly.
