...
**Cutoff Date**|  If a date is entered here, all unposted receipts with a
receipt date less than or equal to the date entered will be selected.
Otherwise, all unposted receipts are selected.

**Receipt ID**|  If you want to post only specific receipts, enter the receipt
numbers in this field. If you leave this field blank and the container id
field blank then all receipts will be posted based on the cut-off date.
...
**Container Id**|  If you wish to post the receipts created for a specific
container, enter the container id in this field.
