...
This field is entered only if you are going to print checks created via the
...
check is wasted because of a printer malfunction, it must be voided with the
[CHECKS.E2](../CHECKS-E2/README.md) procedure. Any checks which are used for the form
alignment process are voided automatically.
