...
**Run Number**|  If you wish to run this report for a specific run number,
enter the run number in this field.

**Print Detail Report**|  Check this box if you wish to print a detailed
version of this report. The detailed version will include the accounts payable
or expense items that were paid on each check.
...
**Vendor Id**|  Enter the vendor ids you wish to include in the report. Leave
this field blank to include all vendors.

**Vendor Name**|  This field displays the vendor's name.
