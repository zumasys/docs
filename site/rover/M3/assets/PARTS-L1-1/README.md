...
**Part Number**|  Enter the list of specific part numbers to be printed. You
may leave this field empty and use the range option.

**Beginning Part Number**|  If you wish to print a range of part numbers,
enter the starting number here.

**Ending Part Number**|  If you wish to print a range of part numbers, enter
the ending number here.

**Invloc**|  Enter the inventory location for which you wish to print labels.
One label for each part on hand will be printed.
