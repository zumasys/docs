...
**Include Totals**|  Select this option if you do not wish to include the
totals on the report. This option is usually selected when sending the data to
...
**Rep Number**|  If you only want to list the sales records for particular
reps then enter the rep numbers in this field. To include all rep numbers
leave the field blank. If you do not know the rep number, there is an option
in the help menu for the prompt which allows you to select the rep by name.
...
**Customer**|  If you only wish to run this report for specific customers,
enter the customer numbers in this field.
