...
this report (i.e. the first of a range of dates).

**End Date**|  Enter the ending transaction date you wish to appear on this
report (i.e. the ending date of a range).

**Acct#**|  Enter the account number for which you wish to print transactions.

**Acct Description**|  This field contains the account description, as read
from the GLCHART file.

**Detail/Summary**|  To print only the lines of the journal entry which
contain the account number specified, enter 'S'. Enter 'D' to print complete
detail of the journal entries.
