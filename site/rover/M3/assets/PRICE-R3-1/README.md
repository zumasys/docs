...
**Category**|  Enter the categories you wish to appear on this report. Leave
this field blank to include all categories.

**Status**|  If you wish to limit this report to parts with certain status
codes, enter those codes here. The valid status codes are:
...
**Price Code**|  If you wish to run this report for specific price codes,
enter the price codes in this field.

**Exlude Std Prices**|  Check this box if you wish to exclude the standard
prices from the report.

**Print Extended Description**|  If this box is checked the first 500
characters of the description will appear on the report. If this option is not
selected, only the first line of the description will appear on the report.
