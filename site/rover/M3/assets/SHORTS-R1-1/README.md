...
**Make Buy Selection**|  Enter MAKE in this field if you wish to run this
report for make parts only. Enter BUY in this field to run the report only for
buy parts. Enter BOTH in this field or leave the field blank to run the report
for both make and buy parts If the part is defined as combination part (both
make & buy), it will show on both the make and buy reports.
