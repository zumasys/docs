...
print for the currency code entered on the purchase order. If no currency code
has been entered on the order, the amount will appear in U.S. dollars.
...
purchase orders by date. The date which is entered here is the print date for
the purchase order.
...
**Ending Order**|  Enter the ending purchase order, if you wish to print a
range of orders.
