...
**Call Back Cutoff Date**|  Enter the date which you wish to use as a cutoff
for the call back date(s) in the prospect file.

**Include Detail Notes**|  If you wish to include the detail contact notes
from screen 2 of the [PROSPECT.E](../PROSPECT-E/README.md) procedure, check this box.
