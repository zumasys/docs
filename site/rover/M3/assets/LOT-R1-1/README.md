...
**Lot Number**|  Enter the number of the lot record to be listed.

**S)ources or D)estinations**|  Enter the letter "S" to list the source lots
for the lot record, or enter "D" for destination lots.
