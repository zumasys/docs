...
**Order No.**|  Enter the field service order number to be printed.
...
printing to blank paper so that the company name would appear on the form. If
you are printing the form on standard letterhead which already contain the
company name and address, you would not want to check the box.
