...
date here. If you leave this date null, all schedules through the selected end
date will will be printed.

**End Date**|  If you wish to select a range of dates, enter the ending date
here. If you leave this date null, all schedules from the selected start date
will be printed.

**Plan Group**|  Enter the planning group for which you wish to run this
report.

**Item Numbers**|  You may limit the listing to include only those item
numbers that you specify in this field. If you leave this field blank then all
planning bills with a forecast within the specified start and end dates will
be included.

**Description**|  Contains the description of the associated item. The data is
for information only and may not be changed.
