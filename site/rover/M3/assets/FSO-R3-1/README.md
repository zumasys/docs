...
**End Date**|  Enter the end date to be used in determing the orders included
in the report. All service orders that were completed on or before the end
date will be included.

**Include Rma Credits?**|  Check this box if you wish to include the
time/money credited back to the customer via the rma process.

**Service Unit**|  Enter the service unit(s) that you want to include in the
report, or leave blank to include all service units. The data on this report
will be a summary for all service units. If you wish to see a break-down of
the data by service unit, run [FSO.R2](../FSO-R2/README.md).
