...
**Cutoff Date**|  Enter the date to be used as the cutoff date for selecting
the work orders to be finalized. Any work order that has a close date less
than or equal to the date entered will be finalized.
