...
**Customer**|  If you wish to run this process for specific customers, enter
the customer numbers in this field.

**Vendor Name**|  The name of the vendor is displayed in this field for
reference.

**Update Sales Orders**|  Check this box when you are ready to post the
results ot the sales order file. If you wish to view the results before
