...
**Cutoff Date**|  If you only wish to view unposted transaction through a
given date, enter that date here. If this field is left blank, all unposted
journal entries will be included.
