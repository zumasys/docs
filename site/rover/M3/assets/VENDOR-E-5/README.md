...
| **Change Date**|  The date the vendor record was changed. This is only
...
also be included in vendor change notices sent by email.

**Change Notes**|  Enter any notes associated with changes made on this date
and time. These notes will also be included in vendor change notices sent by
email.
