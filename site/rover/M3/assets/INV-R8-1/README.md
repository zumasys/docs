...
**Specs**|  Enter the specification, or list of specifications for which you
wish to print a listing.

**Inventory Only**|  If you wish to restrict this report to only those parts
with inventory, check this box.
