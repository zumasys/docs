...
**Version Date**|  Enter the date of the customer's current M3 softwareversion.
...
**PD Base Estimate**|  Enter the estimated hours to apply to the first change
to a PD record.

**PD Addition Estimate**|  Enter the hours to be applied for each PD change
beyond the first one.

**BP Base Estimate**|  Enter the hours required for the first change to a
basic program.

**BP Addition Estimate**|  Enter the hours to be applied for each basic
program change beyond the first one.

**FDICT Estimate**|  Enter the hours to be applied to reimplement all changes
to an fdict record.

**Menu Base Estimate**|  Enter the hours to be applied for implementing all of
the changes to at MENU.

**PADEF Estimate**|  Enter the hours to be applied for reimplementing all of
the changes to a PADEF.
