## Recurring Accounts Receivable Purge Process (ARR.P2)
<PageHeader />

**Form Details**
[Form Details](../ARR-P2-1/README.md)

**Purpose**
The ARR.P2 procedure is used to purge closed ARR records from the data base.
The criteria used to deterime which records are purged is based on a user
defined cut-off date. All recurring accounts receivable records which have a
closed date that is less than or equal to the cut-off date will be deleted.
