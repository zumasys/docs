...
**Department**|  Enter each department you would like included in the report.
The departments will be printed in the order they are entered. If you want to
list all of the departments, leave this field blank. You should also leave
this field blank if you want to print only specific work centers. These can be
specified at the next prompt.

**Work Center**|  Enter all of the work centers you want included in the
report. The work centers will be printed in the order they are entered. If you
want to print all work centers then leave this field blank.

**Over-Utilized Only**|  Check this box if you only want to print those work
centers which show insufficient capacity in a period.
