...
**Forecast Id**|  Enter the forecast ids that you wish to run the report for.
A page break will occur after each id.

**Exclude Current Forecast Qty**|  If you wish to exclude the current forecast
qty from the report, check this box.

**Exclude Original Forecast Qty**|  If you wish to exclude the original
forecasted qty from this report, check this box.
