...
**SO**|  Enter the sales order numbers you wish to include in this report.
Leave this field blank to include all sales orders.
...
**Exclude Shortages for Non-Sales Orders**|  Check this box to exclude
shortages that exist for work orders that were not created for a specific
sales

**Exclude Totals**|  Check this box to exclude the total linees from printing
on the report. This option is often selected when exporting the report to
Excel and the gird viewer.
