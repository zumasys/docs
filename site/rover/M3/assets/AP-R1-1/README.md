...
**Cutoff Date**|  If you wish to select all accrual records through a
particular date, enter that date here.

**Sort By**|  Select the method you wish to sort the report by. If no entry is
made in this field, the report will sort by receipt date.
...
**Vendor**|  If you wish to limit this repor to certain vendors, enter the
vendor numbers in this field.

**Vendor Name**|  The name of the associated vendor. This field is displayed
for reference only.
