...
**Order Types**|  If you wish to run this report for specific sales order
types, enter the type codes in this field. These type codes would have
originally been entered on the order in [SO.E](../SO-E/README.md).
