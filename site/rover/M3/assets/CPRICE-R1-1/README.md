...
**Active Only?:**|  Check the box if you want to list only active price
contracts. Leave unchecked to display all price contracts.

**Cust ID**|  To list price contracts only for certain customers, enter the
customer number(s) here. Leave blank to list all price contracts.
