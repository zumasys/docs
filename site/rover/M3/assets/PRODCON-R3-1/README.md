...
**Configuration ID**|  Enter the number of each configuration to be printed.

**Active Options Only**|  Check this box if you want to see only the options
that are marked as active or expert.

**Include Program Code**|  Check this box if you want the program code printed
on the report.
