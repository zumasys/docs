...
**Cutoff Date**|  Enter the cutoff date to be used in this procedure. This is
a required field. If you are closing quotes based on the quote date, all
quotes were created before on this date will be closed. If you are closing
quotes based on the date the quote was valid thru, all quotes with a valid
thru date that is less than or before this date will be included.

**Status Code**|  Enter the status code you want posted to the soquote record.

**Update File**|  If you wish to review the results before updating the file,
