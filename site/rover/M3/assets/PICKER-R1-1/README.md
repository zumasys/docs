...
**Work Order Numbers**|  Enter all of the work order numbers for all of the
picklists you want printed.

**Include Line Stock Items**|  Check this box if you want to include line
stock components in the picking list.

**Inclue Return to Stock Items**|  Check this box if return to stock items are
to be included in the printed picklist. Return to stock items are designated
on the pick list as negative quantities which are recovered during the
manufacturing

**Print Barcodes**|  Check this box if you wish to print barcodes on the
picklist.

**Sequence**|  Enter one of the following or leave blank for picklist sequence
(default): "B" for Bin Location Sequence. "P" for Picklist Sequence. "R" for
Reference bin sequence.
