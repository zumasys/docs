...
Leave this field empty to include all status codes.

**Prospect**|  Enter the prospect(s) for which you wish to run this report.

**Name**|  The name of the prospect as is appears in the prospect file.
