...
**First BOM Number**|  Enter the number of the first bill of material to be
used in the comparison. You may also enter a model number, category or
manufacturer part.

**Effective Date**|  Enter the effective date to be used against the first
bill of material. If you want to run a full comparison that does not take the
...
**Reference Designator**|  Check this box if you want the reference
designators on the bills of material to be compared.
