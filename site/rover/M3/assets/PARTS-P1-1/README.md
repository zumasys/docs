...
**Method**|  Enter "1" to use part cost only to rank the parts. Enter "2" to
use part cost X average usage to rank the parts.

**"A" Code Cutoff**|  Enter the unit cost to be used to identify the "A"
parts. For example, if you wish to make any parts with a unit cost of $1000 or
more an "A" part, enter 10000.

**"B" Code Cutoff**|  Enter the unit cost to be used to identify the "B"
parts. For example, if you wish to make any parts with a unit cost of $250 or
more an "B" part, enter 250.
...
method and will be used to determine which unit cost to use in the
