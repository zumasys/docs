...
**Cust#**|  Enter the customer number for which you wish to list records.
Leave this field empty to print all customers.

**Name**|  This field contains the customer name, as it appears in the Cust
file.

**Include closed?**|  To include closed ARR records in the listing, enter 'Y'.

**Company Code**|  Enter the company code(s) you wish to appear on this
report. Leave blank to include all codes.
