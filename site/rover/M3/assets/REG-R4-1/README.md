...
**Start Date**|  If you wish to run this report for a specific time frame,
...
**Include GLTRANS records**|  Check this box if you wish to include
transactions that were made for manual journal entries via
[GLTRANS.E](../GLTRANS-E/README.md) or the g/l recurring process and not from the
interface procedure.

**Include Account Description**|  Check this box if you wish to include
description for the g/l account number on the report.

**Exclude Totals**|  Check this option if you do not wish to include the
totals on the report. This option would most likely be selected when exporting
the data to Excel or a text file.
