...
**Customer Numbers**|  Enter the numbers of all of the customers you want to
include in the listing or leave this field blank to include all customers by
customer name. If you do not know the customer number, there is an option in
the help menu for this prompt which allows yout to select the customer by
name.
...
**Start Date**|  You may restrict the listing to include only those sales
orders with a date greater than or equal to the date entered in this field. If
you do not want to restrict the listing to a date range then leave this field
blank.
...
**End Date**|  You may restrict the listing to include only those sales orders
with a date less than or equal to the date entered in this field. If you do
not want to restrict the listing to a date range then leave this field blank.
