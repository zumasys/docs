...
**Cutoff Date**|  This date defines the cutoff date for the selection of the
receipt records. The actual date used in the process will be the last day of
the month in which the cutoff date falls (e.g. 07-16-99 will select records
through 07-31-99). The start date will be determined by the number of periods
entered in the next field.

**Periods**|  Enter the number of periods (months) of receipts history to
summarize.
