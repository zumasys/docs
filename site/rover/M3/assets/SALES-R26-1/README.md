...
**Cost Group**|  Enter the cost group to be used when using the current
standard cost in this report. The cost group must be defined in the
[INV.CONTROL](../INV-CONTROL/README.md) procedure. Leave blank if using the actual
sales cost.
...
**Category**|  Enter the categories of parts you wish to run this report for.
