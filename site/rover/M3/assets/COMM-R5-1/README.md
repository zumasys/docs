...
**Check Run#**|  Enter the check run number for which the payment report is to
be printed. This will list the details for all checks in the check run.

**Check Number**|  Enter the check number for which the payment report is to
be printed. This will print the detail for this check only.
...
**Summary**|  Check this box if you wish to run a summary report by invoice
number.
