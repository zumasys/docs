...
**Routing Numbers**|  Enter the numbers of all the routings you want to have
printed or displayed.

**Effective Date**|  Enter the effectivity date to be used for the routings.
If none is entered the current date will be used.
