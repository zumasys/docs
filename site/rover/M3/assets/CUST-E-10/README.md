...
| **Change Date**|  The date the customer record was changed. This is only
...
-  
**Change Time**|  The time the customer record was changed. This field is
system controlled and cannot be changed.

**Changed By**|  The User ID of the person who changed the customer record.
...
also be included in customer change notices sent by email.

**Change Notes**|  Enter any notes associated with changes made on this date
and time. These notes will also be included in customer change notices sent by
email.
