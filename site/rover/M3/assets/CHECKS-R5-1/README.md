...
**Disb.Account**|  Enter the cash disbursement account(s) for which you wish
to run this report. Leave this field empty to print all accounts.

**Account Description**|  The account description as it appears in the GLCHART
file.
