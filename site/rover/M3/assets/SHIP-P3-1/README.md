...
**Start Date**|  Enter the start date range within which the shjip date must
...
shipments with the associated codes will be exported. If this field is left
blank, all shipments regardless of the status will be selected.

**Shipments**|  Enter the shipment number(s) you wish to export. Leave this
field empty to export all shipments for the date range entered.
