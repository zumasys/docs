...
**Start Date**|  Enter the starting date for which you wish to run this
report.

**End Date**|  Enter the ending date of the range for which you are running
this report.

**Type code**|  Enter the type code(s) for which you wish to run this report.

**Sort By**|  Select the method you wish to sort the report by. If no method
is selected, the report will sort by the NCMR id.
