...
**Record Id**|  Enter the record ID for which you wish to list all AP Register
records. Examples of record ids would be the check number or the a/p id which
might be a receiver number (1348-2) or a misc. number (123) assigned by the
system.
