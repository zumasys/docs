...
**Cust#**|  Enter the vemdpr number for which you wish to list records. Leave
this field empty to print all vendor.

**Name**|  This field contains the vendor name, as it appears in the VENDOR
file.

**Include Closed**|  To include closed ARR records in the listing, check this
box.

**Co Code**|  Enter the company code(s) you wish to appear on this report.
