...
**Exclude Customers on Hold**|  If you wish to exclude customers on credit
hold, check this box.

**Open Balance**|  Check this box if you only wish to include customers with
an open A/R or sales order amount.

**Past Due Invoices**|  Check this box if you only wish to include customers
with past due invoices. For purposes of this report, the invoice is considered
past due if it exceeds the day limit referenced in [CUST.E](../CUST-E/README.md) or
[AR.CONTROL](../AR-CONTROL/README.md).

**No Dollar Limit**|  Check this box if you only wish to include customers for
which no dollar or credit limit has been defined in [CUST.E](../CUST-E/README.md).
