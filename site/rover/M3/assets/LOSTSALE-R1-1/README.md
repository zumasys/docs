...
**End Date**|  Enter the end date to be used in this report. All records with
a date greater than or equal to the start date and less than or equal to the
end date will be include. If no dates are specified all records will be
included.
...
**Reason Code Description**|  The description for the associated code as
defined in [LOSTSALE.CONTROL](../LOSTSALE-CONTROL/README.md).
...
**Include Notes**|  Check this box if you wish to include the notes entered
for the lostsales records on this report.
