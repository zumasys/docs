...
**Next Action Date**|  Enter the next action date. If this date is present,
then any open AR record with a next action date less than or equal to this
...
**Status desc**|  This field contains the description of the collection status
code, as found in [ACCT.CONTROL](../ACCT-CONTROL/README.md).
