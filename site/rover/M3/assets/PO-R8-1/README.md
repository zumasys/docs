...
**Exclude Non-Inventory**|  If you wish to exclude non-inventory items from
this report, check this box. Non-inventory items are purchase order lines
which do not contain a part number.
