...
**Part Number**|  Enter all of the part numbers you want to have
included on the report or leave theis field blank
to include all part numbers in the listing. If
you do not know the part number you may enter the
model number, manufacturer part number or a part
category.

**Status**|  You may restrict the items included on the report to the status
you specify in this field. Leave
the field blank to include all types.

**Start Date**|  Enter the beginning date for this report. If this field is
left blank all sales orders dated prior to the end date will be included.

**End Date**|  Enter the ending date for this report. If this field is left
blank all sales orders dated >= to the beginning date will be included.
