...
**Start Date**|  Enter the start date range within which the ship date must
fall to be selected for this procedure. Leaving this field null will assume
you wish to select all shipments dated prior to the end date entered.

**End Date**|  Enter the end date range within which the shipment date must
fall to be selected for this report. Leaving this field null assumes you wish
to select all shipments since the start date entered.

**Status**|  Enter the status codes you wish to include in this procedure. All
misc shipments with the associated codes will be exported. If this field is
left blank, all shipments regardless of the status will be selected.

**Shipments**|  Enter the miscellaneous shipment number(s) you wish to export.
Leave this field empty to export all shipments for the date range entered.
