...
**Purchase Order Number**|  Enter the list of specific purchase requisitions
you to have printed. To print ranges by date or order number, leave this field
empty. To print all requisitions which have not yet been printed, leave all
fields on this screen empty.

**Form Name**|  Select the form to be used.

**Start Date**|  Enter the start date, if you wish to print a range of
purchase requisitions by date. The date which is entered here is the print
date for the purchase requisition.

**End Date**|  Enter the end date, if you wish to print a range of purchase
requisitions by date. The date which is printed here is the print date for the
purhcase requisition.

**Starting Order**|  Enter the starting purchase requisition, if you wish to
print a range of orders.

**Ending Order**|  Enter the ending purchase requisition, if you wish to print
a range of orders.
