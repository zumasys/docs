...
**Log Type**|  Select if you want to include only Login entries, Logout
entries, or All entries. If left blank All entries will be included.
...
**Computer Name**|  If you want to limit the report to a specific computer
name, enter the name of the computer here.
