...
| **Work order number**|  Enter the work order number which identifies this
bill of material.

-  
**Work Order Assembly**|  The assembly number for which the above work order
was created.
...
**Part Description**|  Contains the first line of the part description from
the parts file. It may not be changed.

**Code**|  Enter one of the following codes which defines the item being
entered for this line item.
...
routing (typically when the assembly is finished). Or enter the specific
