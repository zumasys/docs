...
**Categories**|  You may limit the listing to include only the part numbers
associated to the categories you specify in this field. If you want to list
all of the parts then leave this field blank.

**Status**|  You may limit the listing to include only the part numbers with
the status codes you specify in this field. The following codes are available:
A - Approved
P - Preliminary
C - Change in Process
I - Inactive
D - Set for Deletion Leave the field blank to see all parts regardless of
status.
