...
**Customer Number**|  Enter the number of the customer you want to report
against. If you leave this field blank then all customers will be listed. If
you do not know the customer number, there is an option in the help menu for
this prompt which allows you to select the customer by name.

**Coo Code**|  Enter the company codes you wish to appear on this report. If
left blank all company codes
will be included.
