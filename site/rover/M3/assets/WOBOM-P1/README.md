...
**Purpose**
The WOBOM.P1 procedure is used to purge inactive work order bills of material
from the data base. The criteria used to deterime which records are purged is
based on a user defined cut-off date. All work order bills of material whose
...
work order bill of material records until their associated work order is
deleted then you do not need to run this procedure. The work order purge
procedure ([WO.P2](../WO-P2/README.md)) will delete the work order bill of material at
