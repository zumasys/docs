...
**Start Date**|  If you wish to limit this report to a date range, enter the
starting date in this field. If a date range is entered, only RMA receipts
that have a receipt date that falls within the date range will be selected.

**End Date**|  If you wish to limit this report to a date range, enter the
ending date in this field. If a date range is entered, only RMA receipts that
have a receipt date that falls within the date range will be selected.

**Fail Code**|  If you wish to run this report for specific failure codes,
enter the codes in this field. If no entry is made in this field, all failure
codes will be included in the report.
