...
**Hold Code**|  Enter a user defined hold code to limit the report selection
to sales orders with a particular hold code. Otherwise, leave blank to select
all sales orders on hold. The hold code specified would apply to either the SO
header or SO line item hold code.
