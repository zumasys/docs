...
**Customer Numbers**|  Enter all of the customer numbers you want to have
included in the listing or leave this field blank to include all customers in
customer name order. If you do not know the customer
...
will be included in the listing. If no date is entered, the current date is
used as the cutoff.

**WO.SO.Flag**|  Check here if you want to list only the work orders tied to
the individual sales orders in the listing. If not checked, then the list will
show all open work orders for the associated part number.
