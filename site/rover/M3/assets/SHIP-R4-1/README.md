...
**Status**|  Enter the status codes (N = new, S = shipped and P = posted) you
wish to include in this report.

**Schedule or Cust Reqd Date**|  Enter an "S" to base delivery performance on
...
**Summary**|  Check this box if you wish to run the report in summary.
