...
**Starting Check**|  Enter the starting electronic check#. This must be
prefixed by "E" and will be defaulted by the system and is controlled by the
ECHECKS entry in LIID.E. It can be changed as necessary.
