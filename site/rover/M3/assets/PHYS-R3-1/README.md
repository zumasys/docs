...
**Location**|  Enter the inventory locations you wish to run this report for.
If this field is left blank, all locations will be selected.

**Include Zero Inventory Tags**|  Check this box, if you wish to include the
tags that were created to zero out inventory. These tags are created during
the [PHYS.P1](../PHYS-P1/README.md) procedure.
