## Clocktime Purge Process (CLOCKTIME.P1)
<PageHeader />

**Form Details**
[Form Details](../CLOCKTIME-P1-1/README.md)

**Purpose**
The CLOCKTIME.P1 procedure is used to purge transaction records that contain
the clock in and out dates and times for an employee. The criteria used to
deterime which records are purged is based on a user defined cut-off date. All
transaction records which have a post date that is less than or equal to the
cut-off date will be deleted.
