...
containers due for receipt. This date is used to select containers with an
...
**Shipper ID**|  Enter the shipper number or partial shipper number if you
want to limit the list of containers to include only those with a particular
shipper number.
