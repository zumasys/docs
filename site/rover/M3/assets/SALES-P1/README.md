## Sales History Purge Process (SALES.P1)
<PageHeader />

**Form Details**
[Form Details](../SALES-P1-1/README.md)

**Purpose**
The SALES.P1 procedure is used to purge sales history records from the data
base. The criteria used to deterime which records are purged is based on a
user defined cut-off date. All sales history records whose creation date is
