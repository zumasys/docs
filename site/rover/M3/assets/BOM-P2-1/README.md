...
**Cutoff Date**|  Enter the date to be used as the cutoff date for determining
which line items will be removed from the bills of material. Each line with an
ending effectivity date that is less than or equal to the date entered will be
removed.
