...
**Starting Check Number**|  If you wish to post a range of check numbers then
enter the starting check number here. An ending check number must also be
entered. This will allow you to partially post a check run in cases where you
might need to reprint some of the checks but not all. If you are posting the
entire check run, you do not need to enter a check number in this field.

**Ending Check Number**|  If you wish to post a range of check numbers, enter
the ending check number here. A starting check number must also be entered.
This will allow you to partially post a check run in cases where you might
need to reprint some of the checks but not all. If you are posting the entire
check run, you do not need to enter a check number in this field.
