## Shop Transaction Purge Process (ST.P1)
<PageHeader />

**Form Details**
[Form Details](../ST-P1-1/README.md)

**Purpose**
The ST.P1 procedure is used to purge shop transaction records from the data
base. The criteria used to deterime which records are purged is based on a
user defined cut-off date. All transaction records which have a post date that
