...
**Name**|  Contains the name of the rep associated with the rep number
entered. It may not be changed.

**Customer**|  If you wish to limit this report to specific customers, enter
the customer numbers in this field. To include all customers leave the field
blank. If you do not know the customer number, there is an option in the help
menu for this prompt which allows you to select the customer by name.

**Name**|  Contains the name of the customer number entered. It may not be
changed.

**RMA Sales**|  Chose an option if you want to include only sales from RMA's
or exclude them. Leave blank to ignore this option.

**So Type**|  If you wish to run this report for specific sales order type
codes, enter the codes in this field.
...
**Category**|  If you wish to run this report for specific categories,, enter
the category codes in this field. Leave this field blank to include all
categories.
