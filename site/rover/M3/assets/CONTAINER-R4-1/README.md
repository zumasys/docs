...
**Container**|  Enter the container number(s) you wish to print. If you want
to print all containers received on certain dates, leave this field blank and
...
**Received**|  Check here if you want to see containers in a "R"eceived
status.
