...
| **Change Date**|  The date the part number was changed. This is only stored
...
**Changed By**|  The User ID of the person who changed the part number. This
...
also be included in the part number change notices sent by email.

**Change Notes**|  Enter any notes associated with changes made on this date
and time. These notes will also be included in the part number change notices
sent by email.
