...
**Years**|  Enter the number of years you wish to appear on this report. The
first year that will be selected is the current year. If no entry is made in
this field, the report will only include the current year.

**Customer**|  If you wish to run this report for specific customers, enter
the customer numbers in this field. Leave this field blank to include all
customers.
...
**Company Codes**|  Enter the company codes you wish to include in the report.
If no entry is made in this field, all company codes will be included.
