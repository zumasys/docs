...
**Detail**|  If you wish to show each line of detail from the ARTAX file,
enter 'D'. If you wish to summarize the detail into one line per code, enter
'S'. If you leave this field null, detail is assumed.
...
**State**|  If you wish to run this report for selected states, enter the
state code(s). These state codes must exist in the [STAX.E](../STAX-E/README.md)
records for this field to have an impact.
