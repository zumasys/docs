...
period in the MRP horizon. The period sizes defined in the
[PLAN.CONTROL](../PLAN-CONTROL/README.md) record are offset from this date to determine
the period start and end dates for the horizontal report.

**Planning Group**|  Enter the name of the planning group that is to
processed. Planning Groups are defined in the [PLAN.CONTROL](../PLAN-CONTROL/README.md)
procedure. If you do not specify which planning group to process then the
first one defined in [PLAN.CONTROL](../PLAN-CONTROL/README.md) is assumed.
