...
| **Change Date**|  The date the RMA was changed. This is only stored if one
of two conditions are met: 1) The parameters are set in
...
also be included in RMA change notices sent by email.

**Change Notes**|  Enter any notes associated with changes made on this date
and time. These notes will also be included in RMA change notices sent by
email.
