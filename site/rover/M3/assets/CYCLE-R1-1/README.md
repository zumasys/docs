...
**Location(s)**|  Enter the inventory location to be used in the creation of
the cycle count listing. The inventory balances for this location will be
printed for each part. If you wish to print a cycle count sheet for all
eligible inventory locations, leave this field null.
...
**Print Full Description**|  Check this box if you wish to print the entire
part description. If this box is not checked, only the first line of
