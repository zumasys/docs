...
**Sort Date**|  Enter a "R" or leave blank to sort this report by receive
date. Enter a "P" to sort the report by the post date. The post date is the
date the receipt was entered on the system.

**Debit Receipts Only**|  Check this box if you only wish to include debit
receipts in the report. Debit receipts are receipt that were created via
...
**Exclude Totals**|  Check this box if you do not wish to include totals on
the report.
