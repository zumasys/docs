...
**Print Invoices**|  If this option is selected, [AR.F4](../AR-F4/README.md) will be
launched for you after all invoices or AR records have been created. The
invoice numbers will be loaded into the [AR.F4](../AR-F4/README.md) procedure for you
so you do not have to re-enter them.
