...
**Month Start Date**|  Enter the first date of the month for the month you
want to update usage.

**Month End Date**|  Enter the last day of the month for which you want the
usage file updated.

**Prev Month**|  Check this box if you want to run this procedure for the
month that is immediately prior to the dates being entered. This is intended
to be used with the nightly BE.E process, since the dates entered are the
current month start and end dates. This allows the USAGE.P1 process to be put
into the nightly process, yet update the previous months' figures, rather than
the current month.
