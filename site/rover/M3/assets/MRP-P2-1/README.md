...
**Plan Group**|  Enter the name of the planning group that is to be processed.
Planning Groups are defined in the [PLAN.CONTROL](../PLAN-CONTROL/README.md) procedure.
If only one plan group is defined, it will be loaded for you.
