...
fall to be selected for this this report. Leaving this field null assumes you
wish to select all checks through the end date entered.
...
to select all checks with a date after the start date.
...
**Include Notes**|  Check this box if you wish to include the notes on the
report.
