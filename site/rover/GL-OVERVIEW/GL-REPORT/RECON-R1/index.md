...
**Form Details**  
[ Form Details ](RECON-R1-1/index.md)   

**Purpose**  
The RECON.R1 procedure is used to print a listing of bank reconciliation data which was entered in [ RECON.E ](../../../AR-OVERVIEW/AR-ENTRY/RECON-E/index.md) . The user is prompted for a Recon ID and the month start date, month end date and cash account number will be displayed for verification.   
...
**Dep.ID** The deposit ID assigned to the Cash record in [ CASH.E ](../../../AR-OVERVIEW/AR-ENTRY/CASH-E/index.md) .   
