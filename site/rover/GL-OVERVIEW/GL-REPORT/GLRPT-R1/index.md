...
**Form Details**  
[ Form Details ](GLRPT-R1-1/index.md)   

**Purpose**  
The GLRPT.R1 procedure is used to list the structure of selected or all GLRPT financial report frameworks. The report is used to audit the data entry of the report structures entered by [ GLRPT.E ](../../../../rover/GL-OVERVIEW/GL-ENTRY/GLRPT-E/index.md) . 
...
**To Account** The ending account number to printed if a range has been entered in [ glrpt.e ](../../GL-ENTRY/GLRPT-E/index.md) .   
