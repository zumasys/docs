...
**Current period** This field contains the current fiscal period that is entered in [ GL.CONTROL ](../../../GL-ENTRY/GL-CONTROL/index.md) . This field cannot be changed in this procedure. If you wish to close a different year, update the year in [ GL.CONTROL ](../../../GL-ENTRY/GL-CONTROL/index.md) .   
  
**Current year** This field contains the current fiscal year that is entered in [ GL.CONTROL ](../../../GL-ENTRY/GL-CONTROL/index.md) . This field cannot be changed in this procedure. If you wish to close a different year, update the year in [ GL.CONTROL ](../../../GL-ENTRY/GL-CONTROL/index.md) .   
