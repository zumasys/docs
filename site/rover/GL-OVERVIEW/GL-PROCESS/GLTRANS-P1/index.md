...
**Prerequisites**  
Setup of the [ GL.CONTROL ](../../GL-ENTRY/GL-CONTROL/index.md) record ( [ GL.CONTROL ](../../GL-ENTRY/GL-CONTROL/index.md) ) and the establishment of a fiscal year via the [ FY.E ](../../GL-ENTRY/FY-E/index.md) procedure. All account numbers used must be present in the GLCHART file. 
