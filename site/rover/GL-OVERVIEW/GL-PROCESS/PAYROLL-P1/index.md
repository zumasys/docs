...
**Form Details**  
[ Form Details ](PAYROLL-P1-1/index.md)   
...
Columns 2 and three will be repeated for each rate type defined in the [ LABOR.CONTROL ](../../../PRO-OVERVIEW/PRO-ENTRY/LABOR-CONTROL/index.md) record. There will be one row of data per employee number/id.   
