...
- Coordinate with [Purchasing: Procure-to-Payment](../procure-to-payment/index.md) to ensure POs created from planning follow standard receiving and payment steps.
