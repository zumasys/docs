...
**Form Details**  
[ Form Details ](EMPTIME-P1-1/index.md)   

**Purpose**  
This procedure is used for clocking out all employees or a group of employees that are currently clocked. This would replace the use of [ EMPTIME.E2 ](../../PRO-ENTRY/EMPTIME-E2/index.md) and could be used in situations such as fire-drills, a power outage that suspends all work, or sudden plant closure. It produces a report of all employees and jobs that were clocked out.   
