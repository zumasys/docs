...
**Material** Enter the general ledger account number to be used when material dollars are manually adjusted using the [ WOMATL.E ](../../WOMATL-E/index.md) procedure. The offset account for the entry is defined by the WIP location for the work order.   
  
**Outside Processing** Enter the general ledger account number to be used when outside processing is posted to a work order with the [ WOOP.E ](../../WOOP-E/index.md) procedure. The offset account is defined by the WIP location for the work order.   
