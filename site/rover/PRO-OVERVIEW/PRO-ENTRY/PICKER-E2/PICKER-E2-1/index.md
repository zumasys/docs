...
**Item** Line item number identifying an item to be pulled from inventory. Line items can only be added/deleted if the [ wo.control ](../../WO-CONTROL/index.md) record has been flagged to allow changes in this procedure.   
  
**Part** The part number to be pulled from inventory. This field may be changed if the [ WO.CONTROL ](../../WO-CONTROL/index.md) record has been flagged to allow changes. If that flag has not been set, changes to this field are only permiitted via [ PICKER.E1 ](../../PICKER-E/index.md) .   
...
**Pull Loc** This field contains the inventory location that the parts will be pulled from. If the [ WO.CONTROL ](../../WO-CONTROL/index.md) has been flagged to allow changes to this field, you will be able to change the location. If the [ WO.CONTROL ](../../WO-CONTROL/index.md) has not allowed to allow such changes, this field is displayed for reference only and the location must be changed from [ PICKER.E1 ](../../PICKER-E/index.md) .   
