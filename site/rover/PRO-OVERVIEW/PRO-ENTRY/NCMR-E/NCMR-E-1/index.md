...
**Status** Select the status code for this NCMR record. These codes are defined in the [ NCMR.CONTROL ](../../../../../rover/PRO-OVERVIEW/PRO-ENTRY/NCMR-CONTROL/index.md) screen.   
...
**Discrepancy code** Select the appropriate discrepancy code from the list. This list is updated in [ NCMR.CONTROL ](../../../../../rover/PRO-OVERVIEW/PRO-ENTRY/NCMR-CONTROL/index.md) .   
  
**Discrepancy desc** This field contains the discrepancy description, as found in [ NCMR.CONTROL ](../../../../../rover/PRO-OVERVIEW/PRO-ENTRY/NCMR-CONTROL/index.md) and cannot be changed here.   
...
**Disposition** Select the apprpriate disposition code. This list is defined in [ NCMR.CONTROL ](../../../../../rover/PRO-OVERVIEW/PRO-ENTRY/NCMR-CONTROL/index.md) .   
  
**Disp Notes** Enter any pertinent disposition notes.  
  
**Approved By** Enter your name when this NCMR has been approved. Your user login ID must match one on file in [ NCMR.CONTROL ](../../../../../rover/PRO-OVERVIEW/PRO-ENTRY/NCMR-CONTROL/index.md) for this field to be allowed.   
  
**Approved date** This field contains the date which this record was approved.  
  
**Create DMR** If this option is selected, [ DMR.E ](../../../../PUR-OVERVIEW/PUR-ENTRY/DMR-E/index.md) will be opened and will be populated with the data entered on this screen.   
