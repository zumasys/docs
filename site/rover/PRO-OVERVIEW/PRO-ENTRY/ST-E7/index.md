...
**Form Details**  
[ Move Instructions ](ST-E7-1/index.md)   
[ Materials Used ](ST-E7-2/index.md)   
...
This procedure performs the same function as [ ST.E3 ](../ST-E3/index.md) except that it is optomized for bar coded entry based on settings defined in the [ BAR.CONTROL ](../BAR-CONTROL/index.md) procedure. 
