...
**Employee ID** Enter the identification of the employee whose labor records
are to be listed. If left blank then all employees will be included.  
  
**Employee Name** The employee name is displayed in this field after the
...
**Department** Enter the departments to be included in the listing. If you do
not specify any departments then all will be included. Either work center or
department can be entered, but not both.  
