...
**Form Details**  
[ Form Details ](EMP-R3-1/index.md)   

**Purpose**  
EMP.R3 is used to list all employees that have not been clocked into the system via the [ EMPTIME.E ](../../PRO-ENTRY/EMPTIME-E/index.md) procedure. 
