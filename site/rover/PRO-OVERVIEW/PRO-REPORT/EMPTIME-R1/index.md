...
**Form Details**  
[ Form Details ](EMPTIME-R1-1/index.md)   
...
**Home Center** The employees home work center as defined in the [ EMP.E ](../../PRO-ENTRY/EMP-E/index.md) procedure for the employee. This may be different than the work center of the job the employee is currently working in.   
...
working on was started.  
**Func** The function codes the employee is currently working in. These are defined in the [ LABOR.CONTROL ](../../PRO-ENTRY/LABOR-CONTROL/index.md) procedure.   
**WO.ID** If the function code defines a direct labor function (i.e. no account number is associated with it in [ LABOR.CONTROL ](../../PRO-ENTRY/LABOR-CONTROL/index.md) ) the work order number the employee is logged into will be displayed.   
