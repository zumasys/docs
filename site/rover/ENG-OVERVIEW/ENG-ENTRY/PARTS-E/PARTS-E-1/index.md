...
[ PARTS.P2 ](../../../ENG-PROCESS/PARTS-P2/index.md) procedure.   
...
**UM** Enter the unit of measure used to account for this part in inventory. The valid codes are entered in the [ UM.CONTROL ](../../UM-CONTROL/index.md) procedure.   
...
**Specs** This field may contain any user defined specifications which can be used to group this part number with other part numbers with similar specifications. You may limit the entries available to the user by specifying valid codes with the [ SPEC.CONTROL ](../../SPEC-CONTROL/index.md) procedure.   
