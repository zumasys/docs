...
**Serial Rqd** Check here if a serial number must be designated when the part is sold through [ PSO.E ](../../../../MRK-OVERVIEW/MRK-ENTRY/PSO-E/index.md) .   
  
**No Cat Disc** Check here if this part should not receive its normal category discount found in [ CAT.CONTROL ](../../CAT-CONTROL/index.md) when sales occur in [ PSO.E ](../../../../MRK-OVERVIEW/MRK-ENTRY/PSO-E/index.md) .   
