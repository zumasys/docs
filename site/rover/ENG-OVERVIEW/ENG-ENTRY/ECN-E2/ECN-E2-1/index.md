...
**Affected Area Description** This field contains the description assigned to the associated affected area code. It is defined in the [ ECN.CONTROL ](../../ECN-CONTROL/index.md) procedure.   
  
**Approval Type** The types or areas associated with the approval name and
date.  
  
**Approved By** Enter the name of the person giving approval of the ECN for the associated approval type. The person approving the ECN must be logged on with a login ID that has been defined in [ ECN.CONTROL ](../../ECN-CONTROL/index.md) as having authority to approve the particular type.   
