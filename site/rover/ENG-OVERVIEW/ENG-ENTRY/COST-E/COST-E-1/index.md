...
**Cost Group** Enter the cost group which will be validated against [ INV.CONTROL ](../../../../INV-OVERVIEW/INV-ENTRY/INV-CONTROL/index.md) . The cost group is used to define the costing method and to group inventory locations together for averaging the cost within those locations.   
...
**Stamp Date Current** This field is for reference only and cannot be changed. It is updated when [ COST.P1 ](../../../ENG-PROCESS/COST-P1/index.md) or [ COST.P2 ](../../../ENG-PROCESS/COST-P2/index.md) is processed.   
  
**Stamp Date Std** This field is for reference only and cannot be changed. It is updated when [ COST.P1 ](../../../ENG-PROCESS/COST-P1/index.md) or [ COST.P2 ](../../../ENG-PROCESS/COST-P2/index.md) is processed.   
  
**Stamp Date Previous** This field is for reference only and cannot be changed. It is updated when [ COST.P1 ](../../../ENG-PROCESS/COST-P1/index.md) or [ COST.P2 ](../../../ENG-PROCESS/COST-P2/index.md) is processed.   
