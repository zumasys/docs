...
**Form Details**  
[ Selection Control ](PARTCHANGE-E-1/index.md)   
[ General Changes ](PARTCHANGE-E-2/index.md)   
[ Material Control Changes ](PARTCHANGE-E-3/index.md)   
[ Customer/Supplier ](PARTCHANGE-E-4/index.md)   
[ Images ](PARTCHANGE-E-5/index.md)   
[ Parts Selected ](PARTCHANGE-E-6/index.md)   
[ Select Text ](PARTCHANGE-E-7/index.md)   
...
The GENERAL CHANGES, MATERIAL CONTROL CHANGES, CUSTOMER/SUPPLIER and IMAGES tabs mimic the tabs in the [ PARTS.E ](../PARTS-E/index.md) (master parts entry) procedure. If you wish to change the existing data, enter the new value in the appropriate field. For example, to change the status of the parts to "I" (i.e. inactive), type in "I" in the status field on the GENERAL CHANGES tab.   
