...
**Form Details**  
[ Form Details ](BOM-R5-1/index.md)   

**Purpose**  
The BOM.R5 procedure is used to create a report of the items that will be affected if a mass change update ( [ BOM.P3 ](../../ENG-PROCESS/BOM-P3/index.md) ) were to be performed using the same parameters.   
