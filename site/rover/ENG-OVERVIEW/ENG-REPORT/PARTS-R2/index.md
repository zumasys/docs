##  Parts Master Listing by ABC Code (PARTS.R2)

<PageHeader />

**Form Details**  
[ Form Details ](PARTS-R2-1/index.md)   
...
**Prerequisites**  
The [ PARTS.P1 ](../../ENG-PROCESS/PARTS-P1/index.md) process must have been run to stratify the parts. 
