...
**Form Details**  
[ Form Details ](PRODCON-R3-1/index.md)   
...
**Act** Set to "Y" if the option is active and available for selection, "E" if it is only available through [ PRODCON.E2 ](../../ENG-ENTRY/PRODCON-E2/index.md) , and "N" or null if the option is not available.   
