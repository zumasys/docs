...
**Form Details**  
[ Form Details ](PARTS-R1-1/index.md)   
...
If the report is sent to Excel or the grid viewer, the data for each part will appear on a single row. The description and notes will be capped at 500 characters each. Only the first five manufacturers entered in [ PARTS.E ](../../ENG-ENTRY/PARTS-E/index.md) will appear on the report. 
