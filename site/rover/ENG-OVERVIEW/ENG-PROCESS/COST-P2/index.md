...
**Form Details**  
[ Form Details ](COST-P2-1/index.md)   
...
**Frequency of Use**  
The rollover process is usually run only once a year at the close of a fiscal year. It is also used during system implementation to initialize the standard costs after they have been entered into the system via the current cost fields with [ COST.E ](../../ENG-ENTRY/COST-E/index.md) . 

**Prerequisites**  
A cost rollup ( [ COST.P1 ](../COST-P1/index.md) ) should always be performed prior to running this procedure. 
