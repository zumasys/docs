...
will be listed. If no entry is made in this field, the report will be sorted
by part.  
  
**Co Code** Enter the company codes you wish to appear on this report. If left
blank all company codes will be included.  
  
**Part Number** If you wish to limit this report to specific parts, enter the
part numbers in this field.  
  
**Description** This field contains the first line of description of the part.  
  
**Vemdpr** If you wish to run this report for specifc vendors, enter the
