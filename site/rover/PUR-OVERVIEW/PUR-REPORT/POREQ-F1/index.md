...
**Form Details**  
[ Form Details ](POREQ-F1-1/index.md)   
...
**Frequency of Use**  
Requisition forms may be printed as required and may be also be re-printed at any time. The [ POREQ.E ](../../PUR-ENTRY/POREQ-E/index.md) procedure may be enabled to automatically print the forms as well by setting parameters on the printing tab in [ PO.CONTROL ](../../PUR-ENTRY/PO-CONTROL/index.md) . 
