##  PO Price Listing (POPRICE.R1)

<PageHeader />

**Form Details**  
[ Form Details ](POPRICE-R1-1/index.md)   

**Purpose**  
The POPRICE.R1 procedure provides the ability to list all of the prices defined in the [ POPRICE.E ](../../PUR-ENTRY/POPRICE-E/index.md) procedure. The report is listed in part number sequence. There is an option to choose only selected part 
