...
**Form Details**  
[ Form Details ](PO-P3-1/index.md)   

**Purpose**  
The PO.P3 procedure recalculates and sets the open order amount in the vendor file. This amount is displayed on query procedures such as the vendor inquiry ( [ VENDOR.Q ](../../../../rover/AP-OVERVIEW/AP-REPORT/VENDOR-Q/index.md) ). 
...
**Prerequisites**  
Entry of purchase order records ( [ PO.E ](../../PUR-ENTRY/PO-E/index.md) ). 
