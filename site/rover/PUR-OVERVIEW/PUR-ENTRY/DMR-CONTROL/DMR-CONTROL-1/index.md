...
**Exception Code** Enter the failure codes to be used in the [ DMR.E ](../../DMR-E/index.md) procedure. These codes define the type of failure that caused the rejection of the items.   
...
**Months of Statistics** Enter the number of months of vendor rating statistics to maintain in the VendorRating file. During the [ VENDOR.P2 ](../../../../AP-OVERVIEW/AP-PROCESS/VENDOR-P2/index.md) process, all months in excess of this number will be dropped. If this field is left blank, 12 months are maintained.   
