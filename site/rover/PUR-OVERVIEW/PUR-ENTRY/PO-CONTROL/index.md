...
- [Defaults](PO-CONTROL-1/index.md)
- [PO Req Parameters](PO-CONTROL-2/index.md)
- [Container Parameters](PO-CONTROL-3/index.md)

**Purpose**  
The PO.CONTROL procedure is used to define default information which will be used by the purchase order entry procedure ( [PO.E](../PO-E/index.md) ). The information entered in this procedure is loaded into the corresponding fields on new purchase orders so that the same information does not have to be entered on every purchase order. The user has the option of changing any of these defaults on the purchase order after they are loaded. The procedure also defines the options for automatic printing of purchase orders and receipt travelers from [PO.E](../PO-E/index.md) and [RECEIPTS.E](../RECEIPTS-E/index.md) .
