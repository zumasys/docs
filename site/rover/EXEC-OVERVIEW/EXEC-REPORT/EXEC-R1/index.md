...
**Form Details**  
[ Form Details ](EXEC-R1-1/index.md)   
...
This information is also available via the [ EXEC.Q ](../EXEC-Q/index.md) inquiry. 

**Frequency of Use**  
As required.

**Prerequisites**  
The [ EXEC.P1 ](../../EXEC-PROCESS/EXEC-P1/index.md) procedure must have been run for the date selected. 
