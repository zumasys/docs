...
### Chart of Accounts Setup ([`GLCHART.E`](../../GL-OVERVIEW/GL-ENTRY/GLCHART-E/index.md))
...
### Terms Codes Definition ([`TERMS.E`](../AP-ENTRY/TERMS-E/index.md))
...
### Accounting Parameters ([`ACCT.CONTROL`](../AP-ENTRY/ACCT-CONTROL/index.md))
...
### AP Controls and Defaults ([`AP.CONTROL`](../AP-ENTRY/AP-CONTROL/index.md))
...
### Vendor Master Information ([`VENDOR.E`](../AP-ENTRY/VENDOR-E/index.md))
...
### Recurring Payments Setup ([`APR.E`](../AP-ENTRY/APR-E/index.md))
...
### Create Recurring Payments ([`APR.P1`](../AP-PROCESS/APR-P1/index.md))
...
### AP Invoice Entry ([`AP.E`](../AP-ENTRY/AP-E/index.md))
...
### Register Date Changes ([`AP.E2`](../AP-ENTRY/AP-E2/index.md))
...
### Hand Check Entry ([`CHECKS.E`](../AP-ENTRY/CHECKS-E/index.md))
...
### Void and Stop Payments ([`CHECKS.E2`](../AP-ENTRY/CHECKS-E2/index.md))
...
### Create AP from Receipts ([`RECEIPTS.P1`](../../PUR-OVERVIEW/PUR-PROCESS/RECEIPTS-P1/index.md))
...
### Modify Prechecks ([`PRECHECKS.E`](../AP-ENTRY/PRECHECKS-E/index.md))
...
**Tractor-Feed Forms ([`CHECKS.F1`](../AP-REPORT/CHECKS-F1/index.md)):**

- Continuous-form checks
- High-volume processing
- Standard business checks

**Laser Forms ([`CHECKS.F2`](../AP-REPORT/CHECKS-F2/index.md)):**

- Single-sheet checks
- Professional appearance
- Customizable layouts

### Post Check Run ([`CHECKS.P1`](../AP-PROCESS/CHECKS-P1/index.md))
...
### Determine Eligible Commissions ([`COMM.R4`](../AP-REPORT/COMM-R4/index.md))
...
### Create Commission Run ([`COMM.P3`](../AP-PROCESS/COMM-P3/index.md))
...
### Cancel Commission Run ([`PRECOMM.P1`](../AP-PROCESS/PRECOMM-P1/index.md))
...
**Tractor-Feed Forms ([`CHECKS.F3`](../AP-REPORT/CHECKS-F3/index.md)):**

- Continuous commission checks
- High-volume commission processing

**Laser Forms ([`CHECKS.F4`](../AP-REPORT/CHECKS-F4/index.md)):**

- Professional commission checks
- Custom commission layouts

### Post Commission Checks ([`CHECKS.P3`](../AP-PROCESS/CHECKS-P3/index.md))
...
### Select ACH Items ([`AP.P1`](../AP-PROCESS/AP-P1/index.md))
...
### Create ACH File ([`CHECKS.P7`](../AP-PROCESS/CHECKS-P7/index.md))
...
### Post ACH Checks ([`CHECKS.P1`](../AP-PROCESS/CHECKS-P1/index.md))
...
### AP Distribution Listing ([`AP.R10`](../AP-REPORT/AP-R10/index.md))
...
### Accrual Report ([`AP.R9`](../AP-REPORT/AP-R9/index.md))
...
### Register Listings ([`APREG.R1`](../AP-REPORT/APREG-R1/index.md) / [`APREG.R2`](../AP-REPORT/APREG-R2/index.md))

Review detailed register activity:

**Detailed Register ([`APREG.R1`](../AP-REPORT/APREG-R1/index.md)):**

- Complete transaction history
- All register entries
- Full audit trail

**Filtered Register ([`APREG.R2`](../AP-REPORT/APREG-R2/index.md)):**

- Specific date ranges
- Selected vendors
- Particular transaction types

### Bank Reconciliation ([`RECON.E`](../../AR-OVERVIEW/AR-ENTRY/RECON-E/index.md))
...
- Bank reconciliation listing available via [`RECON.R1`](../../GL-OVERVIEW/GL-REPORT/RECON-R1/index.md) report

### General Ledger Interface ([`GLINT.P1`](../../GL-OVERVIEW/GL-PROCESS/GLINT-P1/index.md))
...
### Generate 1099 Data ([`AP1099.P1`](../AP-PROCESS/AP1099-P1/index.md))
...
**Audit 1099 Data ([`AP1099.R1`](../AP-REPORT/AP1099-R1/index.md)):**

- Review 1099 calculations
- Identify potential issues
- Verify vendor information

**Modify 1099 Data ([`AP1099.E`](../AP-ENTRY/AP1099-E/index.md)):**

- Adjust vendor/representative data
- Correct calculation errors
- Handle special circumstances

**Check Adjustments ([`CHECKS.E3`](../AP-ENTRY/CHECKS-E3/index.md)):**
...
**Continuous Forms ([`AP1099.F1`](../AP-REPORT/AP1099-F1/index.md)):**

- High-volume 1099 printing
- Standard IRS forms

**Laser Forms ([`AP1099.F2`](../AP-REPORT/AP1099-F2/index.md)):**
