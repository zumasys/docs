...
**Form Details**  
[ Form Details ](VENDOR-R4-1/index.md)   
...
This report is similar to [ AP.R4 ](../../../../rover/AP-OVERVIEW/AP-REPORT/AP-R4/index.md) but will include misc. checks that were issued to the vendor. Misc.checks are checks that were not used to pay an invoice. 
