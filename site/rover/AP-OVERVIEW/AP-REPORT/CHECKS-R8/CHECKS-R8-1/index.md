...
**Include Misc** Check this box if you wish to include miscellaneous checks. Miscellaneous checks are entered in [ CHECKS.E ](../../../AP-ENTRY/CHECKS-E/index.md) and are issued to pay non-accounts payable expenses. Checks that are issued to pay for both a/p invoices and misc. expenses will be included in this report even if this option is not selected. Checks that are classified as "pre-pays" will, also, be included in this report.   
