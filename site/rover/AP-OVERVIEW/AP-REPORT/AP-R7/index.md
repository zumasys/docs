...
**Form Details**  
[ Form Details ](AP-R7-1/index.md)   

**Purpose**  
The [ AP.R1 ](../../../../rover/AP-OVERVIEW/AP-REPORT/AP-R1/index.md) procedure is used to print an invoice register of invoices and debit memos. The report selects all items issued for a selected period. The report may be sorted either by AP item (invoice/memo number) or by date. 
