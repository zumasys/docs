...
**Form Details**  
[ Form Details ](AP-F3-1/index.md)   

**Purpose**  
AP.F3 provides a printed form, using a PDF background, for debits being issued to a vendor. While the [ RECEIPTS.F2 ](../../../PUR-OVERVIEW/PUR-REPORT/RECEIPTS-F2/index.md) procedure will print debit receipt debit memos, it is possible to directly enter a debit memo via [ AP.E ](../../../../rover/AP-OVERVIEW/AP-ENTRY/AP-E/index.md) . This procedure will provide a form to be sent to the vendor. 
...
**Debit Number** The debit number assigned to the return which was assigned during the [ AP.E ](../../../../rover/AP-OVERVIEW/AP-ENTRY/AP-E/index.md) procedure. This ID may also have been assigned during a debit receipt.   
