...
**Starting Check** Enter the number of the first check to be printed. If a check is wasted because of a printer malfunction, it must be voided with the [ CHECKS.E2 ](../../../../../rover/AP-OVERVIEW/AP-ENTRY/CHECKS-E2/index.md) procedure. Any checks which are used for the form alignment process are voided automatically.   
