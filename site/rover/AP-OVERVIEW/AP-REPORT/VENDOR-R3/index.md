...
**Form Details**  
[ Form Details ](VENDOR-R3-1/index.md)   
...
**Prerequisites**  
The [ VENDOR.P2 ](../../AP-PROCESS/VENDOR-P2/index.md) procedure must have been run to summarize the vendor statistics for the period(s) on which you want to report. 
...
**Overall Perform**  
**Quality Rating** The Quality Rating multiplied by the Quality weighting as defined in the [ VENDOR.E ](../../AP-ENTRY/VENDOR-E/index.md) procedure.   
**Delivery Rating** The Delivery Rating multiplied by the Delivery weighting as defined in the [ VENDOR.E ](../../AP-ENTRY/VENDOR-E/index.md) procedure.   
