...
**Form Details**  
[ Form Details ](AP-R2-1/index.md)   

**Purpose**  
The AP.R2 procedure is used to create a listing of all A/P items which have a hold flag present. The hold flags and dates were placed on the record during the [ AP.E ](../../../../rover/AP-OVERVIEW/AP-ENTRY/AP-E/index.md) procedure as required by the user. 
