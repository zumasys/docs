...
**AR Aging Method** Select the default for the aging method in [ AR.R3 ](../../../../AR-OVERVIEW/AR-REPORT/AR-R3/index.md) : Invoice Date (default), Due Date, or Register Date. Note: The Register Date is generally only used to balance the aging to the General Ledger at period end.   
...
**Activity Days** Enter the number of days used to determine how much activity is shown in the [ CUST.Q ](../../../../AR-OVERVIEW/AR-REPORT/CUST-Q/index.md) procedure (i.e. AR activity). This field only controls the number of days which are displayed in the [ CUST.Q ](../../../../AR-OVERVIEW/AR-REPORT/CUST-Q/index.md) procedure and has no bearing on the amount of history maintained. If this field is changed, the activity in [ CUST.Q ](../../../../AR-OVERVIEW/AR-REPORT/CUST-Q/index.md) will be changed the next time the [ SALES.P2 ](../../../../MRK-OVERVIEW/MRK-PROCESS/SALES-P2/index.md) procedure generates the snapshot data.   
...
**Update Sales** Check this box if you wish to have Sales records created during [ AR.E ](../../../../AR-OVERVIEW/AR-ENTRY/AR-E/index.md) . Leave this box unchecked if Sales records should only be created from shipments and rma receipts. Please note, that sales records are created by line item. Therefore, if you create an invoice with no line items no sales records will be created.   
  
**Update Commissions** Check this box if you wish to have commission records created during [ AR.E ](../../../../AR-OVERVIEW/AR-ENTRY/AR-E/index.md) . Leave this box unchecked if commission records should only be created from shipments or rma receipts. Please note, that comm records are created by line item. Therefore, if you create an invoice with no line items no comm records will be created.   
  
**Create Commission Accrual Records** Check this box if you wish to create register records to accrue commissions at the same time the commission records are created via [ ship.p1 ](../../../../MRK-OVERVIEW/MRK-PROCESS/SHIP-P1/index.md) , [ rmarec.p1 ](../../../../MRK-OVERVIEW/MRK-PROCESS/RMAREC-P1/index.md) , [ ar.e ](../../../../AR-OVERVIEW/AR-ENTRY/AR-E/index.md) and [ comm.e ](../../../../MRK-OVERVIEW/MRK-ENTRY/COMM-E/index.md) . If this box is checked, account numbers must be entered in the following two fields.   
  
**Comm Pay Account** Enter the commission pay/accrual account that will be debited/credited in the ARREG register file when the commission records are created. When the commission record is paid via [ CHECKS.P3 ](../../../AP-PROCESS/CHECKS-P3/index.md) an offsetting entry will be made against this account number in the APREG register file.   
...
**Days AR History** Enter the number of days of AR balance history to be kept for determining the highest AR balance and average AR balance for each customer. This will be displayed on [ CUST.Q ](../../../../AR-OVERVIEW/AR-REPORT/CUST-Q/index.md) . For instance, to see the highest AR balance by customer over the past year, enter 365. It will be a rolling period of time. Note, if you increase the time period, the missing days cannot be automatically recaptured. It will build up to the # days specified. If you decrease the number, the next time [ AR.P6 ](../../../../AR-OVERVIEW/AR-PROCESS/AR-P6/index.md) runs, it will adjust the data accordingly. [ AR.P6 ](../../../../AR-OVERVIEW/AR-PROCESS/AR-P6/index.md) should be included in the nightly batch run.   
  
**AP Aging Method** Select the default for the aging method in [ AP.R3 ](../../../../../rover/AP-OVERVIEW/AP-REPORT/AP-R3/index.md) : Invoice Date, Due Date, Register Date.   
...
**A/P Activity Days** Enter the number of days used to determine how much activity is shown in the [ VENDOR.Q ](../../../../../rover/AP-OVERVIEW/AP-REPORT/VENDOR-Q/index.md) procedure (i.e. AP activity). This field only controls the number of days which are displayed in the [ VENDOR.Q ](../../../../../rover/AP-OVERVIEW/AP-REPORT/VENDOR-Q/index.md) procedure and has no bearing on the amount of history maintained.   
  
**Days AR History** Enter the number of days of AP balance history to be kept for determining the highest AP balance and average AP balance for each vendor This will be displayed on [ VENDOR.Q ](../../../../../rover/AP-OVERVIEW/AP-REPORT/VENDOR-Q/index.md) . For instance, to see the highest AP balance by vendor over the past year, enter 365. It will be a rolling period of time. Note, if you increase the time period, the missing days cannot be automatically recaptured. It will build up to the # days specified. If you decrease the number, the next time [ AP.P7 ](../../../../../rover/AP-OVERVIEW/AP-PROCESS/AP-P7/index.md) runs, it will adjust the data accordingly. [ AP.P7 ](../../../../../rover/AP-OVERVIEW/AP-PROCESS/AP-P7/index.md) should be included in the nightly batch run.   
