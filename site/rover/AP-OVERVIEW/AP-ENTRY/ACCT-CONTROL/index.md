...
- [Defaults](ACCT-CONTROL-1/index.md)
- [Bank Accounts](ACCT-CONTROL-2/index.md)
- [AR Collection](ACCT-CONTROL-3/index.md)
- [Vendor](ACCT-CONTROL-4/index.md)
- [Change History](ACCT-CONTROL-5/index.md)
...
On the BANK ACCOUNTS tab in this procedure, you can enter in the names and accounts of the banks that will be used in banking transactions. If present, the names and accounts will print on the deposit slips that are generated via [CASH.F1](../../../AR-OVERVIEW/AR-REPORT/CASH-F1/index.md).
