...
**AP Acct#** This is the default Account Payable account number used by the [ AP.E ](../../AP-E/index.md) procedure. This is loaded into the AP record automatically and can be changed as required.   
  
**Prechecks AP Account** When creating checks through [ CHECKS.E ](../../CHECKS-E/index.md) , there is an option to create a check (i.e. a precheck) without defining a A/P id or expense account. When using this option, the system will create a debit AP.ID that can be viewed in [ AP.E ](../../AP-E/index.md) . In this field, enter the A/P trade account that should be posted to these debit A/P records. If no entry is made in this field, the account referenced in the AP ACCT# field will be used.   
  
**Misc Acct#** This field is used during [ AP.E ](../../AP-E/index.md) , when an amount is entered in the Miscellaneous Amount field in the header screen. This account number is defaulted and may be changed, as required.   
  
**Freight Acct#** This account number is used as a default during [ AP.E ](../../AP-E/index.md) , when an amount is entered in the Freight Amount field.   
  
**Terms Code** The terms code entered in this field is used in [ AP.E ](../../AP-E/index.md) when a vendor has no default terms code entered.   
  
**Discount Acct#** This account number is used in conjunction with the terms discount applied in the header of [ AP.E ](../../AP-E/index.md) . An entry is made in the APREG file only if the discount is actually taken during a check run, or on a manual check.   
  
**Unit of Measure** This field is used as a default in the line items of [ AP.E ](../../AP-E/index.md) , when a part is entered which does not contain a unit of measure.   
...
**Default reg date** In [ AP.E ](../../AP-E/index.md) , the register date is defaulted to the current system date. If you wish to have the register date default to the invoice date, then set this field.   
