...
**Form Details**  
[ Form Details ](CHECKS-E4-1/index.md)   
...
An existing check record cannot be changed. [ CHECKS.E ](../CHECKS-E/index.md) must be used to delete the record, if necessary. If deleted, the credit memos and debit memo will not be reopened. If you delete records from a prior fiscal/calendar period and you re-run your check reports for those periods, the reports will not match the reports you ran earlier for those periods. 

**Frequency of Use**  
As required to process refund checks.

**Prerequisites**  
Initialization of the Accounts Payable control record ( [ AP.CONTROL ](../AP-CONTROL/index.md) ), the Accounts Receivable control record ( [ AR.CONTROL ](../../../AR-OVERVIEW/AR-ENTRY/AR-CONTROL/index.md) ) and entry of the customer record to be referenced. The credit memos to be closed must exist in the AR file. 
