...
- [Form Details](CHECKS-E2-1/index.md)
...
**Prerequisites**  
Initialization of the Accounts Payable control record ([AP.CONTROL](../AP-CONTROL/index.md)), and entry of the vendor and terms records to be referenced.
