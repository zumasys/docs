...
**Form Details**  
[ Header ](AP-E-1/index.md)   
[ Line Items ](AP-E-2/index.md)   
[ Related AP Items ](AP-E-3/index.md)   
[ Register History ](AP-E-4/index.md)   
[ Attachments ](AP-E-5/index.md)   
...
When an invoice is received for a material receipt, an accrual record will have been created by the [ RECEIPTS.P1 ](../../../PUR-OVERVIEW/PUR-PROCESS/RECEIPTS-P1/index.md) procedure and contain as much information as was known at the time the purchase order was entered. Updating this record with the actual amounts from the invoice will convert it from an accrual to an open accounts payable item.   
  
Debit AP records can also be created via the [ CHECKS.E ](../CHECKS-E/index.md) procedure when a prepayment type check is entered. This type of AP record will have the invoice amount equal to the negative check amount. They cannot be updated in AP.E.   
