...
- [Check](CHECKS-E-1/index.md)
- [Commission](CHECKS-E-2/index.md)
- [Change History](CHECKS-E-3/index.md)
...
When the record is saved, you will be given an option to print the check on a laser based check form if the [AP.CONTROL](../AP-CONTROL/index.md) record has been set-up to allow this function. However, you can only do so if paying 13 a/p and/or expense items or less.
...
**Prerequisites**  
Initialization of the Accounts Payable control record ([AP.CONTROL](../AP-CONTROL/index.md)), and entry of the vendor and terms records to be referenced. The invoices to be paid must exist as AP records.
