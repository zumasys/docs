...
**Form Details**  
[ Form Details ](CHECKS-P6-1/index.md)   

**Purpose**  
The purpose of CHECKS.P6 is to change the check date on posted checks. Checks can be selected for a range of checks or a check run that was created via the [ AP.P1 ](../AP-P1/index.md) procedure. Checks that have been voided or cleared will not be selected.   
