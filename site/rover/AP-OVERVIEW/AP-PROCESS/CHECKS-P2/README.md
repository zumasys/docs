##  Check File Purge Process (CHECKS.P2)

<PageHeader />

**Form Details**  
[ Form Details ](CHECKS-P2-1/README.md)   

**Purpose**  
The CHECKS.P2 procedure is used to purge check records from the data base. The
criteria used to deterime which records are purged is based on a user defined
cut-off date. All check records which have a clear date that is less than or
