...
**Form Details**  
[ Form Details ](VENDOR-P2-1/index.md)   
...
The procedure selects all of the Receipts and DMR records which occured during the month specified and determines the early/late days for each receipt to calculate delivery performance. The quality performance is determined using the DMR records and the weightings for each are specified in [ DMR.CONTROL ](../../../PUR-OVERVIEW/PUR-ENTRY/DMR-CONTROL/index.md) .   
  
Multiple months of statistics are kept and can be reported using [ VENDOR.R2 ](../../AP-REPORT/VENDOR-R2/index.md) or [ VENDOR.R3 ](../../AP-REPORT/VENDOR-R3/index.md) or viewed on [ VENDOR.Q ](../../AP-REPORT/VENDOR-Q/index.md) . All months currently maintained which are in excess of the number of months defined in the [ DMR.CONTROL ](../../../PUR-OVERVIEW/PUR-ENTRY/DMR-CONTROL/index.md) record will be dropped. 
