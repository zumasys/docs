...
**Form Details**  
[ Form Details ](CHECKS-P7-1/index.md)   
...
**Prerequisites**  
[ AP.CONTROL ](../../AP-ENTRY/AP-CONTROL/index.md) , Payment Tab, Electronic Payments fields must be completed prior to [ AP.P1 ](../AP-P1/index.md) . A check run must have been created through the [ AP.P1 ](../AP-P1/index.md) procedure and all checks must have been successfully printed. Need to create a LIID for ECHECKS if starting with a number other than 1. 
