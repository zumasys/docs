...
**Form Details**  
[ Form Details ](CHECKS-P4-1/index.md)   
...
This procedure should be used with caution. When a check is deleted/voided via [ checks.e ](../../AP-ENTRY/CHECKS-E/index.md) or [ checks.e2 ](../../AP-ENTRY/CHECKS-E2/index.md) , reversing entries are made in the apreg, ap and/or check files to reflect this transaction. Checks.p4, however, does not create these reversing transactions. Instead it changes the check numbers posted to the ap, apreg and checks files. A date stamp is posted to the new check number in the checks file to indicate that the check was created/updated via this procedure.   
