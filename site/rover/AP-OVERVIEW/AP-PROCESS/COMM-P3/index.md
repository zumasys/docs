...
**Form Details**  
[ Form Details ](COMM-P3-1/index.md)   
...
**Prerequisites**  
Setup of the Commission Pay Account and Commission Expense Account field in [ ACCT.CONTROL ](../../AP-ENTRY/ACCT-CONTROL/index.md) procedure. It is highly recommended that the [ COMM.R4 ](../../AP-REPORT/COMM-R4/index.md) report be run to give visibility to the commissions which would be selected by this process when the cutoff date is used. 
