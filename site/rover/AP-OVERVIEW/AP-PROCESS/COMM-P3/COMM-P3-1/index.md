...
**Disb.Acct#** Enter the cash disbursement G/L account number which will be used for this check run. This entry is defaulted from the [ AP.CONTROL ](../../../AP-ENTRY/AP-CONTROL/index.md) file but can be changed as required. If no entry is made in this field, the account entered in the [ AP.CONTROL ](../../../AP-ENTRY/AP-CONTROL/index.md) record will be used.   
