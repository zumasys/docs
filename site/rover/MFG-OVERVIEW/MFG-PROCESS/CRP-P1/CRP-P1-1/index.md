...
**Start Date** Enter the date to be used as the start date for the first period in the CRP horizon. The period sizes defined in the [ CRP.CONTROL ](../../../MFG-ENTRY/CRP-CONTROL/index.md) record are offset from this date to determine the period start and end dates for the horizontal report.   
