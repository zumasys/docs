...
**Group** Enter the planning group which applies to this master schedule. This field will be verified against the planning group(s) entered in [ PLAN.CONTROL ](../../PLAN-CONTROL/index.md) . If you have only one planning group this field will be defaulted and skipped.   
...
**Load Dates** Select this button to load the list of schedule dates based upon the planning horizon defined in [ PLAN.CONTROL ](../../PLAN-CONTROL/index.md) . You must first enter a starting date in the associated field.   
  
**Start Date** Enter the starting date to use when the dates are to be auto loaded based upon the [ PLAN.CONTROL ](../../PLAN-CONTROL/index.md) planning horizon.   
