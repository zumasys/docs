...
**Buyer** If you want to restrict the listing to items which are assigned to a specific buyer, then enter the code which identifies the buyer at this prompt. The buyer is associated to the part number in the [ PARTS.E ](../../../../ENG-OVERVIEW/ENG-ENTRY/PARTS-E/index.md) procedure.   
  
**Planner** If you want to restrict the listing to items which are assigned to a specific planner, then enter the code which identifies the planner at this prompt. The planner is associated to the part number in the [ PARTS.E ](../../../../ENG-OVERVIEW/ENG-ENTRY/PARTS-E/index.md) procedure.   
