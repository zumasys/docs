...
**Email Address** Enter the email addresses that will be sent a change notice. The email addresses will appear in a list when the AR record is saved in [ AR.E ](../../../../AR-OVERVIEW/AR-ENTRY/AR-E/index.md) . They can optionally be selected or not at that time. The default selection is controlled with the next field.   
  
**Default Email** When an AR record is filed in [ AR.E ](../../../../AR-OVERVIEW/AR-ENTRY/AR-E/index.md) and a change notice is triggered, then the email addresses will appear in a list to optionally be sent the notice. This field controls whether this email address is always defaulted to send a notice.   
