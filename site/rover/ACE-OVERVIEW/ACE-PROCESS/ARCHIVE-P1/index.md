...
**Prerequisites**  
The retention settings must be defined in [ ARCHIVE.CONTROL ](../../ACE-ENTRY/ARCHIVE-CONTROL/index.md) prior to running this procedure. Files must be marked with the "Include" checkbox and have appropriate "Archive after" and "Delete after" periods specified.
