...
> ***CAUTION:*** Take care when using **SQLUPDATE** that your *WHERE* clause does not inadvertently
...
> ***CAUTION:*** Take care when using **SQLDELETE** that your *WHERE* clause does not inadvertently
match more records than you intended.
