...
Similar functionality can be executed using the [-S option](./../options/README.md) to jkeyauto. Therefore, scripts can be configured so that they wait on a sync. signal and then an operator starts them all off from the command line.
