...
There are several steps to create and setup a kitchen printer. To view the complete in-depth documentation on receipt detail setup refer to the Main POS Training Documentation [here](./../pos-training/index.md). This article is meant for information training purposes and setup.
