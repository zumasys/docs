# SQLUpdateResponse (jbasejdbc   API)

**Created At:** 9/25/2017 11:05:02 AM  
**Updated At:** 2/15/2018 8:02:54 AM  
**Original Doc:** [com_jbase_jdbc_protocol_SQLUpdateResponse](https://docs.jbase.com/39240-protocol/com_jbase_jdbc_protocol_SQLUpdateResponse)  
**Original ID:** 278007  
**Internal:** Yes  
...
- Class
- [Use](./../class-use/uses-of-class-com.jbase.jdbc.protocol.sqlupdateresponse-%28jbasejdbc-api%29)
...
- [Prev Class](./../sqlstartrequest-%28jbasejdbc---api%29 "class in com.jbase.jdbc.protocol")
- [Next Class](./../statementid-%28jbasejdbc-api%29 "class in com.jbase.jdbc.protocol")
